    ...
    <div class="col-lg-12    sheet-page d-flex flex-column" id="showData1" >
        <div class="block new-block position-relative  5 page-block" >
            ...
            <div class="d-flex text-nowrap flex-column h-100 align-items-center justify-content-center">
                ...
                <p class=" text-center mb-0 section-header" style="font-size: 20px !important;">{{date("F d,",
...
<div class="block new-block position-relative  5 page-block"  style="padding-left: 7%;padding-right: 7%;padding-top: 7% !important;">
    ...
    <div class="">
        ...
        <p class="mb-2 section-header" style="font-size: 17px !important;font-weight:500 !important;;">We have compiled the balance sheet of <b class="text-danger">{{$client->company}}</b> as at <b class="text-danger">{{date("F d,",
            strtotime(getFiscalYearEnd($client->fiscal_start)))}} {{ $fyear }}</b> and the statements of income and
                                    ...
                                    <tbody>
                                        ...
                                        ->sum('credit');
                                           ...
                                           if($total_debits_previous_fyear > $total_credits_previous_fyear) {
                                            ...
                                            $amnt_preivous_fyear = rounding($total_credits_previous_fyear - $total_debits_previous_fyear, $rounding);
                                           }
