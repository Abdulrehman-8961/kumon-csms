          ...
          <thead class="thead thead-dark">
              ...
              <tr>
                  ...
                  @if (in_array(8, $column_array))
                      <th data-index=6 style="min-width: 100px">FQDN </th>
                  @endif

                  @if (in_array(9, $column_array))
                      <th data-index=6 style="min-width: 100px">Parent Asset </th>
                  @endif
                  ...
                  @if (in_array(10, $column_array))
                      <th data-index=10 style="min-width: 100px">Role/Description</th>
                  @endif
                  ...
                  @if (in_array(12, $column_array))
                      <th data-index=11 style="min-width: 100px">System Type </th>
                  @endif

                  @if (in_array(51, $column_array))
                      <th data-index=11 style="min-width: 100px">System Category </th>
                  @endif
                  ...
                  @if (in_array(17, $column_array))
                      <th data-index=15 style="min-width: 100px">Manufacturer </th>
                  @endif

                  @if (in_array(18, $column_array))
                      <th data-index=15 style="min-width: 100px">Model </th>
                  @endif

                  @if (in_array(19, $column_array))
                      <th data-index=15 style="min-width: 100px">Type </th>
                  @endif

                  @if (in_array(20, $column_array))
                      <th data-index=15 style="min-width: 100px">SN# </th>
                  @endif
                  ...
                  @if (in_array(26, $column_array))
                      <th data-index=17 style="min-width: 100px">Memory (Gb)</th>
                  @endif
                  ...
                  @if (in_array(40, $column_array))
                      <th data-index=17 style="min-width: 100px">Platform </th>
                  @endif

                  @if (in_array(45, $column_array))
                      <th data-index=17 style="min-width: 100px">vCenter Server</th>
                  @endif

                  @if (in_array(46, $column_array))
                      <th data-index=17 style="min-width: 100px">Cluster/Host</th>
                  @endif

                  @if (in_array(47, $column_array))
                      <th data-index=17 style="min-width: 100px">VM Folder</th>
                  @endif

                  @if (in_array(48, $column_array))
                      <th data-index=17 style="min-width: 100px">VM Datastore</th>
                  @endif

                  @if (in_array(49, $column_array))
                      <th data-index=17 style="min-width: 100px">VM Restart Priority</th>
                  @endif

                  @if (in_array(50, $column_array))
                      <th data-index=17 style="min-width: 100px">vCPU</th>
                  @endif
          ...
          <tbody id="showdata">
              ...
              @foreach ($qry as $q)
                  <tr data="{{ $q->id }}">
                      ...
                      @if (in_array(9, $column_array))
                          <td data-index=12>{{ $q->parent_asset }}</td>
                      @endif
                      ...
                      @if (in_array(12, $column_array))
                          <td data-index=11>{{ $q->system_type_name }}</td>
                      @endif



                      @if (in_array(51, $column_array))
                          <td data-index="39">{{ $q->system_category_name }}</td>
                      @endif
                      ...
                      @if (in_array(17, $column_array))
                          <td data-index=6>{{ $q->vendor_name }}</td>
                      @endif

                      @if (in_array(18, $column_array))
                          <td data-index=6>{{ $q->model }}</td>
                      @endif

                      @if (in_array(19, $column_array))
                          <td data-index=6>{{ $q->type }}</td>
                      @endif
                      ...
                      @if (in_array(27, $column_array))
                          <td data-index=6>
                              ...
                              @elseif(
                                  $q->ssl_certificate_status == 'Active' ||
                                      $q->ssl_certificate_status == 'Unassigned' ||
                                      $q->ssl_certificate_status == 'Expired/Ended')
                      ...
                      {{-- @if (in_array(31, $column_array))
                          @php
                              $sla = null;
                              if (isset($q->sla) && is_numeric($q->sla) && (int) $q->sla == $q->sla) {
                                  $sla = DB::table('sla')->where('id', $q->sla)->first();
                                  $sla_value = $sla->sla_description;
                                } else {
                                  $sla_value = $q->sla;
                              }
                          @endphp
                          <td data-index="12">{{ $sla_value }}</td>
                      @endif --}}
                      ...
                      @if (in_array(45, $column_array))
                          <td>{{ @$q->center_server }}</td>
                      @endif

                      @if (in_array(46, $column_array))
                          <td>{{ @$q->cluster_host }}</td>
                      @endif
                      ...
                      @if (in_array(48, $column_array))
                          <td> {{ @$q->vm_datastore }} </td>
                      @endif

                      @if (in_array(49, $column_array))
                          <td> {{ @$q->vm_retart_priority }} </td>
                      @endif
