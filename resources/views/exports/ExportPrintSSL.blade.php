...
foreach($ssl as $s){
 ...
 $html.='  <div class="block new-block position-relative mt-5" >
    ...
    if($c->AssetStatus!=1){
                                                                             ...
                                                                             $html.='<div data-toggle="tooltip" data-html="true"   title="" class="w-100     AssetActive" style="height: 12mm;padding-top: 8px;    box-shadow: 
                       ...
                       <div class="block-options block-header block-header-default">
                                ...
                                <button type="button" class="btn-block-option" onclick="Dashmix.helpers('print');">
                                    <i class="si si-printer mr-1"></i> Print  
                                     ...
                                     <a  download="" href="{{url('export-pdf-sites')}}?id={{$id}}" type="button" class=" btn btn-alt-primary"  >
