          ...
          <thead class="thead thead-dark">
              <tr>
                  ...
                  @if (in_array(8, $column_array))
                      <th data-index=7 style="min-width: 110px">FQDN </th>
                  @endif
                  @if (in_array(9, $column_array))
                      <th data-index=8 style="min-width: 110px">Parent Asset </th>
                  @endif
                  ...
                  @endif
                  @if (in_array(40, $column_array))
                      <th data-index="39" style="min-width: 100px">System Category</th>
                  @endif
                  ...
                  @if (in_array(17, $column_array))
                      <th data-index=16 style="min-width: 100px">Manufacturer </th>
                  @endif
                  @if (in_array(18, $column_array))
                      <th data-index=17 style="min-width: 100px">Model </th>
                  @endif
                  @if (in_array(19, $column_array))
                      <th data-index=17 style="min-width: 100px">Type </th>
                  @endif
                  @if (in_array(20, $column_array))
                      <th data-index=17 style="min-width: 100px">SN# </th>
                  @endif
                  ...
                  @if (in_array(25, $column_array))
                      <th data-index=17 style="min-width: 100px">CPU </th>
                  @endif
                  ...
                  @if (in_array(41, $column_array))
                      <th data-index=17 style="min-width: 100px">Floor</th>
                  @endif
                  @if (in_array(42, $column_array))
                      <th data-index=17 style="min-width: 100px">Cabinet</th>
                  @endif
                  @if (in_array(43, $column_array))
                      <th data-index=17 style="min-width: 100px">U Start</th>
                  @endif
                   @if (in_array(52, $column_array))
                      <th data-index=17 style="min-width: 100px">U Size</th>
                  @endif
                  @if (in_array(44, $column_array))
                      <th data-index=17 style="min-width: 100px">Contact</th>
                  @endif
          ...
          <tbody id="showdata">
              ...
              @foreach ($qry as $q)
                  <tr data="{{ $q->id }}">
                      ...
                      @endif
                        @if (in_array(40, $column_array))
                          <td data-index=14>{{ @$q->platform }}</td>
                      @endif
                      ...
                      @if (in_array(25, $column_array))
                          <td data-index=6>{{ $q->cpu_sockets }} {{ $q->cpu_model }} {{ $q->cpu_cores }} C @
                              {{ $q->cpu_freq }} GHz</td>
                      @endif
                      ...
                      @php
                          $location = DB::table('assets_location')
                              ->where('asset_id', @$q->id)
                              ->first();
                      @endphp
@if (in_array(5, $column_array))
                          <td data-index=3>{{ @$location->room }}</td>
                      @endif
                      @if (in_array(41, $column_array))
                          <td data-index=14>{{ @$location->floor }}</td>
                      @endif
                      @if (in_array(42, $column_array))
                          <td data-index=14>{{ @$location->cabinet_rack }}</td>
                      @endif
                      @if (in_array(43, $column_array))
                          <td data-index=14>{{ @$location->u }}</td>
                      @endif
                       @if (in_array(52, $column_array))
                          <td data-index=14>{{ @$location->u_size }}</td>
                      @endif
                      @if (in_array(44, $column_array))
                          <td data-index=14>{{ @$location->contact_name }}</td>
                      @endif
