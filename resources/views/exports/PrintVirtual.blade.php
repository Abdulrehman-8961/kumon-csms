                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-2">
                                                <div class="bubble-white-new bubble-text-sec" style="padding:10px">
                                                      ...
                                                      <img src="public/img/static-vm.png" style="width: 100%;">
                                                </div> </div>
...
<div class="contract_type_button w-100 mr-4 px-1 js-tooltip-enabled" data-toggle="tooltip" data-placement="top" title="" data-original-title="System is patched automatically or manually">
...
<div class="contract_type_button w-100 mr-4 px-1 js-tooltip-enabled" data-toggle="tooltip" data-placement="top" title="" data-original-title="System is monitored">
...
<div class="contract_type_button w-100 mr-4 px-1 js-tooltip-enabled" data-toggle="tooltip" data-placement="top" title="" data-original-title="System data is protected">
...
<div class="contract_type_button w-100 mr-4 px-1 js-tooltip-enabled" data-toggle="tooltip" data-placement="top" title="" data-original-title="System has Anti-Virus installed">
...
<div class="contract_type_button w-100 mr-4 px-1 js-tooltip-enabled" data-toggle="tooltip" data-placement="top" title="" data-original-title="System is replicated">
...
<div class="contract_type_button w-100 mr-4 px-1 js-tooltip-enabled" data-toggle="tooltip" data-placement="top" title="" data-original-title="System is scanned by Drawbridge">
...
<div class="contract_type_button w-100 mr-4 px-1 js-tooltip-enabled" data-toggle="tooltip" data-placement="top" title="" data-original-title="System sends info to SIEM/Syslog">
...
<div class="contract_type_button w-100 px-1 js-tooltip-enabled" data-toggle="tooltip" data-placement="top" title="" data-original-title="System requires SMTP Relay Access">
...
$html.='<div class="block block-rounded   table-block-new mb-2 pb-0  -  viewContent" data="110" style="cursor:pointer;">
 ...
 <div style="position: absolute;width: 100%; bottom: 5px;right: 10px;">
                                       <a href="'.url('contracts').'/'.$l->id.'" class="toggle led" data-toggle="tooltip" data-placement="top" data-title="Open" data-html="true" data-original-title="Open">
...
$html.='</div>
  ...
  $line_items=DB::Table('ssl_host as ca')->select('a.cert_name','a.cert_status','a.cert_edate','a.cert_type','a.id','c.logo','a.description','c.client_display_name')->where('ca.hostname',$q->id)->join('ssl_certificate  as a','a.id','=','ca.ssl_id')->join('clients as c','c.id','=','a.client_id')->groupBy('a.cert_name')->where('a.is_deleted',0)->orderBy('ca.id','asc')->get();
...
$html.='<div class="block block-rounded   table-block-new mb-2 pb-0  -  viewContent" data="110" style="cursor:pointer;">
 ...
 <div style="position: absolute;width: 100%; bottom: 5px;right: 10px;">
                                       <a href="'.url('ssl-certificate').'/'.$l->id.'" class="toggle led" data-toggle="tooltip" data-placement="top" data-title="Open" data-html="true" data-original-title="Open">
