...
<?php 
          ...
          $qry=DB::Table('sites as s')->select('s.*','c.client_display_name')->join('clients as c','c.id','=','s.client_id')->where('s.id',$_GET['id'])->first();
                            ...
                            <div class="p-sm-4 p-xl-7">
                                ...
                                <div class="row mb-5">
                                    ...
                                    <div class=" " style="float:left;width: 50%;">
                                       <h3 class="mb-3 text- " >{{$qry->site_name}}</span></h3>  
                                       <h5 style="line-height: 1.5">{{$qry->client_display_name}}<br>
                                        {{$qry->address}}<br>
