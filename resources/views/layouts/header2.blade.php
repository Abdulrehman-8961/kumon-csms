...
<head>
    ...
    <title>{{ isset($title) ? $title . ' | Kumon Control Panel' : 'Kumon Control Panel' }}</title>
    ...
    <style type="text/css">
        ...
        .table-block-new {
            ...
            border: 0.5pt solid lightgrey !important;
        ...
        .table-block-new:hover {
            border: 0.5pt solid #2485E8 !important;
        }
    ...
    background-color: #F9F9F9;
        ...
        .bootstrap-select.export-select .btn {
