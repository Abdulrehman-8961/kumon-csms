      ...
      <div class="tab-content" id="nav-tabContent-edit">
          ...
          @php
              ...
              $students = DB::table('client_students')
                  ...
                  ->get();
          @endphp
          <div class="tab-pane fade show active" id="nav-main-vacation-edit" role="tabpanel"
              aria-labelledby="nav-main-tab-vacation-edit">
                  ...
                  <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                      <div class="row">
                          ...
                          @if (Auth::user()->role != 'parent')
                              <div class="col-sm-6">
                                  <div class="border p-2 mb-3 border-style bg-disabled">
                                      
                                      <h6 class="font-titillium text-grey mb-2 fw-700 pl-1">Client</h6>
                          ...
                          <div class="col-sm-6">
                              <div class="custom-dropdown border p-2 mb-3 border-style edit-border student-dropdown"
                                  data-selected-id="{{ $row->student_id }}"
                                  data-selected-text="{{ $row->student_name }}">
                                  ...
                                  <ul class="dropdown-options">
                                      ...
                                      @foreach ($students as $s)
                                          <li data-value="{{ $s->id }}" data-text="{{ $s->student_name }}"
                                              class="{{ $row->student_id == $s->id ? 'active' : '' }}">
                                              {{ $s->student_name }}</li>
                                      @endforeach
                                  </ul>
                          ...
                          <div class="col-sm-6">
                              <div class="border p-2 mb-3 border-style edit-border calendar-expandable bg-white"
                                  ...
                                  <a href="javascript:void();" class="mandatory-icon position-absolute"
                                      style="right: 24px;" data-toggle="tooltip" data-trigger="hover"
                                      data-placement="top" title="" data-original-title="Mandatory"><i
                                          class="fa-light fa-circle-star text-grey fs-20"></i></a>
                                  ...
                                  <div class="d-flex pb-1 pl-1 pt-0">
                                      ...
                                      <div class="date-input-area flex-grow-1 position-relative">
                                          <input type="text"
                                              ...
                                              id="vacation_date_range" name="vacation_date_range"
                                              value="{{ $row->date_range }}" readonly>
                                          <i class="fa-light fa-circle-xmark clear-icon text-grey d-none fs-20 position-absolute"
                                              id="clear_vacation_date_range"
                                              style="right: 0px; top: 50%; transform: translateY(-50%); cursor: pointer;"></i>
                                      </div>
                                  </div>
                          ...
                          @php
                              $subjects = array_map('strtolower', explode(', ', $row->subject_names));
                          @endphp
                          <div class="col-sm-6">
                              <div class="border p-2 mb-3 border-style edit-radio-border edit-border position-relative">
                                <a href="javascript:void();" class="mandatory-icon position-absolute"
                                      style="right: 9px;" data-toggle="tooltip" data-trigger="hover"
                                      data-placement="top" title="" data-original-title="Mandatory"><i
                                          class="fa-light fa-circle-star text-grey fs-20"></i></a>
                                  ...
                                  <div class="d-flex align-items-center pb-1 pl-1 pt-0" id="add_subjects">
                                      ...
                                      <div class="d-flex">
                                          <div class="radio_button ">
                                              <input type="checkbox" id="sub_math" name="sub_name" value="1"
                                                  {{ in_array('math', $subjects) ? 'checked' : '' }} />
                                              <label
                                                  class="btn radio-label py-1 font-titillium fs-14 fw-300 mx-2 label1"
                                                  for="sub_math">Math</label>
                                          </div>
                                          <div class="radio_button">
                                              <input type="checkbox" id="sub_reading" name="sub_name" value="2"
                                                  {{ in_array('reading', $subjects) ? 'checked' : '' }} />
                                              <label
                                                  class="btn radio-label py-1 font-titillium fs-14 fw-300 mx-2 label1"
                                                  for="sub_reading">Reading</label>
                                          </div>
                                          <div class="radio_button">
                                              <input type="checkbox" id="sub_efl" name="sub_name" value="3"
                                                  {{ in_array('efl', $subjects) ? 'checked' : '' }} />
                                              <label
                                                  class="btn radio-label py-1 font-titillium fs-14 fw-300 mx-2 label1"
                                  ...
                                  <div class="d-flex align-items-center justify-content-between pb-1 pl-1 pt-0">
                                      <div class="custom-control custom-switch">
                                          <input type="checkbox" class="custom-control-input" id="customSwitch1"
                                              name="take_work_home" {{ $row->take_work_home ? 'checked' : '' }}>
                                          <label class="custom-control-label" for="customSwitch1"
                                              name="take_work_home">
                                              <h6 class="font-titillium text-grey fw-300 mb-0 ml-2 switch-text">
                                                  {{ $row->take_work_home ? 'Work required during vacation' : 'No work required during vacation' }}
                                              </h6>
                                          </label>
                                      </div>
                                  </div>
                          ...
                          <div class="col-sm-6">
                              <div class="border p-2 mb-3 border-style d-none" id="reducedWorkloadWrapper">
                                  <div class="d-flex align-items-center justify-content-between mb-2">
                                      ...
                                      <div class="affiliate-tooltip font-titillium text-grey fw-300" style="right: 20px; top: -125px;">
                                          <strong class="titillium-web-black fs-18 text-primary"
                                              style="line-height:1.6;">Reduced Workload</strong><br>
                                          Enabling this option will notify the Kumon instructor that the student does not require a
                                          reduced workload during their vacation period
                                      </div>
                                  </div>
                                  <div class="d-flex align-items-center justify-content-between pb-1 pl-1 pt-0">
                                      <div class="custom-control custom-switch">
                                          <input type="checkbox" class="custom-control-input" id="reducedWorkloadSwitch"
                                              name="reduced_workload" {{ $row->reduced_workload ? 'checked' : '' }}>
                                          <label class="custom-control-label" for="reducedWorkloadSwitch"
                                              ...
                                              <h6 class="font-titillium text-grey fw-300 mb-0 ml-2 switch-text-load">
                                                  {{ $row->reduced_workload ? 'Reduced workload required' : 'Student does not require reduced workload' }}
                                              </h6>
                                          </label>
                                      </div>
                                  </div>
                              ...
                              <div class="border p-2 mb-3 border-style edit-border">
                                  ...
                                  <div class="d-flex pb-1 pl-1 pt-0">
                                      ...
                                      <textarea rows="4"
                                          ...
                                          id="vacation_comments" placeholder="Enter a comment for Kumon instructor">{{ $row->comment }}</textarea>
                                  </div>
                              </div>
                          </div>
                      </div>
      ...
      <script>
          (function() {
              ...
              window._editTrapNativeClickListener = function(e) {
                  ...
                  if (e.target.closest('#nav-main-vacation-edit')) return;
      ...
      <script type="text/javascript">
            ...
            $('[data-toggle="tooltip"]').tooltip({
              ...
              function initializeStudentDropdown() {
                  ...
                  $('.custom-dropdown.student-dropdown').each(function() {
                      ...
                      if (students_array.length === 0) {
                          optionsContainer.find('li:not(.search-option)').each(function() {
                      ...
                      students_array.forEach(student => {
                          const option = $('<li></li>')
                              ...
                              .attr('data-value', student.key)
                              .attr('data-text', student.student_name)
                              .text(student.student_name);
                          optionsContainer.append(option);
                      });

                      const defaultId = dropdown.data('selected-id');
                      const defaultText = dropdown.data('selected-text');

                      if (defaultId && defaultText) {
                          selectedValue.text(defaultText).css('color', '#3f3f3f');
                          hiddenInput.val(defaultId);
                          clearBtn.removeClass('d-none');
                          optionsContainer.find(`[data-value="${defaultId}"]`).addClass('active');
                      } else if (inputName === 'selected_student' && students_array.length === 1) {
                          const onlyStudent = students_array[0];
                          selectedValue.text(onlyStudent.student_name).css('color', '#3f3f3f');
                          hiddenInput.val(onlyStudent.key);
                          clearBtn.removeClass('d-none');
                          dropdown.data('selected-id', onlyStudent.key);
                          dropdown.data('selected-text', onlyStudent.student_name);

                          // Mark the option as active
                          optionsContainer.find(`[data-value="${onlyStudent.key}"]`).addClass('active');
              ...
              function bindStudentDropdownEvents() {
                  $('.custom-dropdown.student-dropdown').each(function() {
                      ...
                      const hiddenInput = box.find('input[type="hidden"]');
        ...
        <tr class="payment-item" data="${i}" data-key="${payments_array[i].key}">
            ...
            <td class="py-2 border-0 text-right drag-handle" width="50" style="opacity:0">
              ...
              $('.header-item-code').text('Edit Vacation');
              $('.header-desc').text('{{ $row->subject_names }}');
              ...
              function loadStudentsByClient(client_id) {
                  if (!client_id) return;

                  $.ajax({
                      url: '{{ url('get-students-by-client') }}/' + client_id,
                      type: 'GET',
                      success: function(response) {
                          const studentDropdown = $('h6:contains("Student Name")').closest(
                              '.custom-dropdown');
                          const optionsList = studentDropdown.find('ul.dropdown-options');
                          ...
                          if (response.length > 0) {
                              $.each(response, function(index, student) {
                                  optionsList.append(
                                      `<li data-value="${student.id}" data-text="${student.student_name}">${student.student_name}</li>`
                                  );
                              });
                          } else {
                              optionsList.append('<li class="text-muted px-2">No student found</li>');
                          }

                          // Reset selected value
                          studentDropdown.find('.selected-value').text('Select Student').css('color',
                              '#999');
                          studentDropdown.attr('data-selected-id', '');
                          studentDropdown.find('input[type="hidden"]').val('');
              ...
              $('.custom-dropdown').each(function() {
                  ...
                  box.on('click.addPage', '.dropdown-options li:not(.search-option)', function() {
                      ...
                      box.find('.dropdown-options li').removeClass('active');
              ...
              function updateSwitch2State() {
                  if ($switch2.is(':checked')) {
                      $('.switch-text2').text('Work required during vacation');
                      $btn2.prop('disabled', false).css({
                          opacity: 1,
                          cursor: 'pointer'
                      });
                  } else {
                      $('.switch-text2').text('No work required during vacation');
                      $btn2.prop('disabled', true).css({
                          opacity: 0.5,
                          cursor: 'not-allowed'
                      });
        ...
        `;
              ...
              $switch.on('change', syncReducedWorkloadVisibility);
              ...
              $switch.on('change', function() {
                  if ($(this).is(':checked')) {
                      $('.switch-text').text('Work required during vacation');
                      $btn.prop('disabled', false).css({
                          opacity: 1,
                          cursor: 'pointer'
                      });
                  } else {
                      $('.switch-text').text('No work required during vacation');
                      $btn.prop('disabled', true).css({
                          opacity: 0.5,
                          cursor: 'not-allowed'
                      });
          ...
          <tbody>`;
            ...
            <td class="py-2 text-center" style="vertical-align: middle;">
              ...
              $(document).off('click.addPage', '.updateBtn').on('click.addPage', '.updateBtn', function(e) {
                  ...
                  let student_id = $('#selected_student').val();
                  let client_id = $('input[name=client_id_add]').val();
                  let student_name = $('.dropdown-options li.active').attr('data-text') ||
                      $('.student-dropdown .selected-value').text().trim();
                  let date_range = $('#vacation_date_range').val();
                  let subjects = [];
                  $('input[name="sub_name"]:checked').each(function() {
                      subjects.push($(this).val());
                  });
                  let take_work_home = $('#customSwitch1').is(':checked');
                  let reduced_workload = $('#reducedWorkloadSwitch').is(':checked');
                  let comments = $('#vacation_comments').val();

                  let validselected_student = validateFieldByIdOrName('selected_student'); // by ID
                  let validvacation_date_range = validateFieldByIdOrName('vacation_date_range'); // by ID



                  if (!validselected_student || !validvacation_date_range || subjects.length === 0) {
                      showFormValidation();
                      var borderDiv = $('.edit-radio-border');
                      let title = borderDiv.find('h6');
                      let icon = borderDiv.find('.constant-icon');
                      if (subjects.length === 0) {
                          borderDiv.attr('style', (i, s) => (s || '') +
                          ...
                          title.attr('style', (i, s) => (s || '') + 'color: #C41E3A !important;');
                          icon.attr('style', (i, s) => (s || '') + 'color: #C41E3A !important;');
                          let errorTarget = borderDiv.length ? borderDiv : "";
                      ...
                      $.ajax({
                          ...
                          success: function(response) {
                              ...
                              setTimeout(function() {
                                  $('#SaveModal').modal('hide'); // Close modal after 4s

                                  // After modal closes, show success notification
                                  //   showSuccessNotify('Contract Added Successfully',
