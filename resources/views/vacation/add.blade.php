      ...
      <div class="tab-content" id="nav-tabContent-edit">
        <style>
          ...
          {{-- Main Tab --}}
          @php
              $clients = DB::table('clients')->where('is_active', 1)->where('is_deleted', 0)->orderBy('client_display_name', 'asc')->get();
                  ...
                  <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                      <div class="row">
                          ...
                          @if (Auth::user()->role != 'parent')
                              <div class="col-sm-6">
                                  <div class="custom-dropdown client-custom-dropdown border p-2 mb-3 border-style edit-border"
                                      ...
                                      <div
                                          ...
                                          <div class="d-flex align-items-center">
                                              <i class="fa-light fa-user-tie text-grey fs-18 constant-icon"></i>
                                              <span
                                                  class="selected-value font-titillium text-placeholder fw-300 mb-0 ml-2 edit-field"></span>
                                          </div>
                                      ...
                                      <ul class="dropdown-options">
                                          ...
                                          @foreach ($clients as $c)
                                              <li data-value="{{ $c->id }}">
                                                  {{ $c->salutation . ' ' . $c->firstname. ' ' .$c->lastname }}</li>
                                          @endforeach
                                      </ul>
                          ...
                          <div class="col-sm-6">
                              <div class="border p-2 mb-3 border-style edit-radio-border edit-border position-relative" style="padding-bottom: 0px !important;">
                                <a href="javascript:void();" class="mandatory-icon position-absolute"
                                      style="right: 9px;" data-toggle="tooltip" data-trigger="hover"
                                      data-placement="top" title="" data-original-title="Mandatory"><i
                                          class="fa-light fa-circle-star text-grey fs-20"></i></a>
                                      ...
                                      <div class="custom-control custom-switch">
                                          ...
                                          <label class="custom-control-label" for="customSwitch1"
                                              ...
                                              <h6 class="font-titillium text-grey fw-300 mb-0 ml-2 switch-text">
                                                  No work required during vacation
                                              </h6>
                                          </label>
                                      </div>
                                  </div>
                          ...
                          <div class="col-sm-6">
                              <div class="border p-2 mb-3 border-style d-none" id="reducedWorkloadWrapper">
                                  <div class="d-flex align-items-center justify-content-between mb-2">
                                      ...
                                      <button type="button"
                                          class="btn banner-icon affiliate-info p-0 cursor-help"
                                      ...
                                      <div class="affiliate-tooltip tooltip-workload font-titillium text-grey fw-300">
                                          <strong class="titillium-web-black fs-18 text-primary"
                                              style="line-height:1.6;">Take Work Home</strong><br>
                                          Enabling this option will send reminders to prepare work for this student
                                          during their vacation period
      ...
      <script type="text/javascript">
          $(document).ready(function() {
            $('[data-toggle="tooltip"]').tooltip({
              ...
              function initializeStudentDropdown() {
                  ...
                  $('.custom-dropdown.student-dropdown').each(function() {
                      ...
                      if (inputName === 'selected_student' && students_array.length === 1) {
                          ...
                          optionsContainer.find(`[data-value="${onlyStudent.key}"]`).addClass(
                              'active');
              ...
              $('.header-item-code').text('New Vacation');
              $('.header-desc').text('Pending Vacation');
        ...
        `;
              ...
              $switchEdit.on('change', function() {
                  if ($(this).is(':checked')) {
                      $('.switch-text').text('Student require reduced workload');
                      $btn.prop('disabled', false).css({
                          opacity: 1,
                          cursor: 'pointer'
                      });
          ...
          <tbody>`;
            ...
            <td class="py-2 text-center" style="vertical-align: middle;">
              ...
              $(document).off('click.addPage', '.updateBtn').on('click.addPage', '.updateBtn', function(e) {
                  ...
                  let student_name = $('.student-dropdown .dropdown-options li.active').attr('data-text') ||
                  ...
                  if (!validselected_student || !validvacation_date_range || subjects.length === 0) {
                      ...
                      $.ajax({
                          ...
                          success: function(response) {
                            localStorage.removeItem('vacation_active_tab');
localStorage.removeItem('vacation_active_tab_target');
                              ...
                              setTimeout(function() {
                                  ...
                                  if (btnType == "continue") {
                                      Dashmix.helpers('notify', {
                                          ...
                                          message: `
    <div>
      <div class="font-titillium" style="font-weight: 800; color: #4EA833; font-size: 15pt;">Vacation Added Successfully</div>
      <div class="d-flex align-items-center">
          <div style="font-size: 14pt; margin-right: 8px;"><i class="fa-thin fa-circle-check"></i></div>
          <div>Vacation has been added successfully.</div>
      </div>
      <div class="d-flex align-items-center">
          <div style="font-size: 14pt; margin-right: 8px;"><i class="fa-thin fa-square-dashed-circle-plus"></i></div>
          <div>Continue adding new contract.</div>
      </div>
    </div>
    `,
                                          allow_dismiss: true,
                                  ...
                                  sessionStorage.setItem('successMessage',
                                      'Vacation has been added successfully.');
