          ...
          <div class="tab-pane fade show active" id="nav-main-vacation-edit" role="tabpanel"
              ...
              <div class="block new-block position-relative mt-3">
                  <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                      <div class="row">
                          <div class="col-sm-12">
                              <h5 class="titillium-web-black mb-3 text-purpule">General Information</h5>
                          </div>
                          @if (Auth::user()->role != 'parent')
                          <div class="col-sm-6">
                              <div class="border p-2 mb-3 border-style bg-disabled position-relative">
      ...
      <script type="text/javascript">
        ...
        <tr class="payment-item" data="${i}" data-key="${payments_array[i].key}">
            ...
            <td class="py-2 border-0 text-right drag-handle" width="50" style="opacity:0">
              ...
              $('.header-item-code').text('Clone Vacation');
        ...
        `;
              ...
              $reducedWorkloadSwitch.on('change', function() {
                  if ($(this).is(':checked')) {
                      $('.switch-text-load').text('Reduced workload required');
                      $btn.prop('disabled', false).css({
                          opacity: 1,
                          cursor: 'pointer'
                      });
