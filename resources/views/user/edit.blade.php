      ...
      <div class="pr-4">
          ...
          <div class="align-items-center container d-flex mb-0 px-2 py-1 mt-2 warning-info-edit pr-3">
                                ...
                                <a href="javascript:void();" class="mandatory-icon position-absolute"
                                  ...
                                  <div class="d-flex pb-1 pl-1 pt-0">
                                      ...
                                      <input type="text"
                                          ...
                                          placeholder="Enter first name" name="first_name" id="first_name" value="{{ $user->firstname }}">
                                  </div>
                              </div>
                          </div>
                          <div class="col-sm-6">
                              <div class="border p-2 mb-3 border-style edit-border position-relative">
                                <a href="javascript:void();" class="mandatory-icon position-absolute"
                                  ...
                                  <div class="d-flex pb-1 pl-1 pt-0">
                                      ...
                                      <input type="text"
                                          class="form-control font-titillium text-grey fw-300 mb-0 ml-2 border-0 p-0 fs-18 rounded-0 edit-field"
                                          placeholder="Enter last name" name="last_name" id="last_name" value="{{ $user->lastname }}">
                                  </div>
                              </div>
                          </div>
                          <div class="col-sm-6">
                              <div class="border p-2 mb-3 border-style edit-border position-relative">
                                <a href="javascript:void();" class="mandatory-icon position-absolute"
                                  ...
                                  <div class="d-flex pb-1 pl-1 pt-0">
                                      ...
                                      <input type="email"
                                          class="form-control font-titillium text-grey fw-300 mb-0 ml-2 border-0 p-0 fs-18 rounded-0 edit-field"
                                          placeholder="Enter Email" name="email" id="email" value="{{ $user->email }}">
                                  </div>
                              </div>
                          </div>
                          <div class="col-sm-6">
                              <div class="border p-2 mb-3 border-style edit-radio-border" style="padding-bottom: 1px !important;">
                                  ...
                                  <div class="d-flex align-items-center pb-1 pl-1 pt-0">
                                      ...
                                      <div class="d-flex">
                                          ...
                                          <div class="radio_button">
                                              <input type="radio" id="role_staff" name="role" value="staff" {{ $user->role == 'staff' ? 'checked' : '' }}/>
                                              <label
                                                  class="btn radio-label py-1 font-titillium fs-14 fw-300 mx-2 label1"
                                                  for="role_staff">Staff</label>
                                          </div>
                                          <div class="radio_button">
                                              <input type="radio" id="role_parent" name="role" value="parent"  {{ $user->role == 'parent' ? 'checked' : '' }} />
                                              <label
                                                  class="btn radio-label py-1 font-titillium fs-14 fw-300 mx-2 label1"
...
<input type="hidden" name="edit_form_id" id="edit_form_id" value="{{ $user->id }}">
          {{-- Comments Tab --}}
      ...
      (function() {
        ...
        <tr class="payment-item" data="${i}" data-key="${payments_array[i].key}">
            ...
            <td class="py-2 border-0 text-right drag-handle" width="50" style="opacity:0">
              ...
              $('.header-item-code').text('Edit User');
              $('.header-desc').text('{{ $user->email }}');
          ...
          <tbody>`;
            ...
            <td class="py-2 text-center" style="vertical-align: middle;">
              ...
              $(document).off('click.addPage', '.updateBtn').on('click.addPage', '.updateBtn', function (e) {
                e.preventDefault();
                let edit_form_id = $('#edit_form_id').val();
