...
@section('content')
    ...
    $selectedUser = null;
    $showResendInviteTopIcon = false;
    if (!empty($GETID)) {
        $selectedUser = DB::table('users')->where('id', $GETID)->first();
        $showResendInviteTopIcon = (int) ($selectedUser->must_change ?? 0) === 1;
    }
        ...
        <div class="con   no-print page-header py-1" id="">
            ...
            <div class="b   mb-0  ">
                                            ...
                                            <form class="push mb-0" method="get" id="form-search"
                                                ...
                                                <div class="input-group mainser banner-icon">
                                                    <input type="text" value="{{ @$_GET['search'] }}"
                                                        ...
                                                        placeholder="Search User" style="font-weight: 300!important;">
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <p class="col-11 bubble-header-text d-flex justify-content-between align-items-center">Users
                                        <span class="{{ $get_text_display }} text-right" style="line-height: 1.3;">
                                            <a class="clear-link" href="{{ url('/users') }}"
                                ...
                                <div class="h-100 d-flex align-items-center">
                                    <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                        ...
                                        <div class="d-flex justify-content-center align-items-center flex-grow-1"
                                            ...
                                            <img src="{{ asset('public/img/cf-menu-icons/main-menu-users-white.png') }}" class="header-image"
                                                style="width: 36px; height: 36px;">
                                        ...
                                        <div class="new-header-icon-div d-flex align-items-center flex-shrink-0 no-print">
                                            ...
                                            <a href="javascript:;" type="button" data-toggle="tooltip" data-trigger="hover"
                                                    ...
                                                    data-original-title="Resend Invite"
                                                    class="btn text-white btn-resend-invite banner-icon sub-nav-icons {{ $showResendInviteTopIcon ? '' : 'd-none' }}"
                                                    data-user-id="{{ @$GETID }}" data-user-email="">
                                                    <i class="fa-light fa-envelope regular-icon" style="font-size: 21px;"></i>
                                                    <i class="fa-solid fa-envelope solid-icon"
                                                ...
                                                <a href="javascript:;" type="button" data-toggle="tooltip" data-trigger="hover"
                                                    ...
                                                    class="btn text-white btn-change-password banner-icon sub-nav-icons"
                                                    data-user-id="{{ @$GETID }}" data-user-email="">
                                                    <i class="fa-light fa-key regular-icon" style="font-size: 21px;"></i>
                                                    <i class="fa-solid fa-key solid-icon"
                                                        style="padding-right: 2px; padding-left: 2.5px; font-size: 21px;"></i>
                                                </a>
                            ...
                            <div class="col-md-8 detail-header detail-header-edit edit-header d-none">
                                <div class="h-100 d-flex align-items-center">
                                    <div class="d-flex align-items-center w-100  " style="justify-content:space-between;">
                                        ...
                                        <img src="{{ asset('public/img/menu-icon-contracts-white.png') }}"
                                                class="header-image img-icon d-none" style="width: 36px; height: 36px;">
                                            <div class="ms-3 flex-grow-1" style="min-width: 0; margin-left: 0.91rem;">
                                                <div class="d-flex align-items-center">
                                                    <div class="header-badge flex-shrink-0">KUM</div>
                                                    <h4
                        ...
                        <div class="row">
                            <div class="col-md-4 bubble-header">
                                ...
                                <div class="filter-dropdown-container roll-down">
                                    <div class="row align-items-center">
                                        <div class="col-1 bubble-fil ter-ht {{ $class }}" style="height: 175px;"></div>
                                            ...
                                            <div class="block block-transparent mb-0">
                                                <div class="pl-3 pt-0 pb-0">
                                                    <div class="align-items-baseline row">
                                                        <label class="col-sm-4 modal-label">User Role</label>
                                                        <div class="col-sm-7 px-sm-0 form-group">
                                                            ...
                                                            <select type="text" class="form-control" id="role" name="role" placeholder="All ">
                                        ...
                                        @foreach ($qry as $q)
                                            <div class="block block-rounded   table-block-new mb-2 pb-0  -  viewContent" data="{{ $q->id }}" style="cursor:pointer;">
                                                <div class="block-content p-2 d-flex">
                                                    <div class="mr-2" style="width:14%;padding: 3px 0px 3px 3px;">
                                                        @if ($q->user_image)
                                                        <img src="{{ asset('public/client_logos/'.$q->user_image) }}" class="rounded-circle  "
                                                            width="100%" style="object-fit: cover;">
                                                            @else
                                                            <img src="{{ asset('public/img/cf-menu-icons/user-icon.png') }}" class="rounded-circle  "
                                                                width="100%" style="object-fit: cover;">
                                                        @endif
                                                    </div>
                                                    <div class="align-content-center d-flex flex-column justify-content-between" style="width:84%; padding: 3px 0px 3px 3px;">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            ...
                                                            <div>
                                                                <div>
                                                                    @if ($q->portal_access && $q->must_change == 1)
                                                                        <i class="fa-light fa-circle-envelope text-darkgrey fs-20"
                                                                            data-toggle="tooltip" data-trigger="hover"
                                                                            data-placement="top" data-title="" data-html="true"
                                                                            data-original-title="Invite Sent"></i>
                                                                    @elseif ($q->portal_access)
                                                        ...
                                                        {{-- <div class="w-100 my-1">
                                                            <div class="d-flex align-items-center mb-0">
                                                                ...
                                                                @endif
                                                                <p class="font-9pt mb-0 text-truncate titillium-web-light ml-1">
                                                                    {{ @$q->payment_method }}
                                                                </p>
                                                            </div>
                                                        </div> --}}
                                                        <div class="d-flex align-items-center justify-content-between w-100">
                                                            <p class="font-12pt mb-0 text-truncate c2 titillium-web-light"
                                                            ...
                                                            <div class="d-flex">
                                                                ...
                                                                <?php     if(Auth::check()) { ?>
                                                                    ...
                                                                    <div class="dropdown-menu"
                                                                        ...
                                                                        <a href="javascript:;"
                                                                            class="dropdown-item d-flex align-items-center btn-change-password-trigger pl-0"
                                                                            data-user-id="{{ $q->id }}"
                                                                            data-user-email="{{ $q->email }}">
                                                                            <i class="fa-light fa-key mx-2 icons-3dot"></i>
                                                                            Change Password
                                                                        </a>
                                                                        @if ((int) ($q->must_change ?? 0) === 1)
                                                                            <a href="javascript:;"
                                                                                class="dropdown-item d-flex align-items-center btn-resend-invite-3dot pl-0"
                                                                                data-user-id="{{ $q->id }}"
                                                                                data-user-email="{{ $q->email }}">
                                                                                <i class="fa-light fa-envelope mx-2 icons-3dot"></i>
                                                                                Resend Invite
                                                                            </a>
                                                                        @endif
                                        ...
                                        <div class="col-md-12 bg-nav-tab position-relative">
                                            <nav class="align-items-center d-flex justify-content-between read-nav-tabs sub-nav-tabs">
                                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                                    <button class="nav-link active" id="nav-main-tab-user" data-toggle="tab"
                                                        data-target="#nav-main-user" type="button" role="tab"
                                                        aria-controls="nav-main-user" aria-selected="true">Main</button>
                                                        <button class="nav-link" id="nav-comments-tab-user" data-toggle="tab"
                                                        data-target="#nav-comments-user" type="button" role="tab"
                                                        aria-controls="nav-comments-user" aria-selected="true">Comments</button>
                                                    <button class="nav-link" id="nav-attachments-tab-user" data-toggle="tab"
                                                        data-target="#nav-attachments-user" type="button" role="tab"
                                                        aria-controls="nav-attachments-user"
                                                        aria-selected="false">Attachments</button>
                                                    <button class="nav-link border-right-0" id="nav-audit-tab-user"
                                                        data-toggle="tab" data-target="#nav-audit-user" type="button"
                                                        role="tab" aria-controls="nav-audit-user" aria-selected="false">Audit
                                                        Trail</button>
                                                </div>
                                        ...
                                        <div class="col-md-12 bg-edit-tab edit-sub-header">
                                            <nav class="sub-nav-tabs edit-nav-tabs d-no ne">
                                                <div class="nav nav-tabs" id="nav-tab-edit" role="tablist">
                                                    <button class="nav-link active" id="nav-main-tab-user-edit" data-toggle="tab"
                                                        data-target="#nav-main-user-edit" type="button" role="tab"
                                                        aria-controls="nav-main-user-edit" aria-selected="true">Main</button>
                                                    <button class="nav-link" id="nav-comments-tab-user-edit" data-toggle="tab"
                                                        data-target="#nav-comments-user-edit" type="button" role="tab"
                                                        aria-controls="nav-comments-user-edit"
                                                        aria-selected="false">Comments</button>
                                                    <button class="nav-link border-right-0" id="nav-attachments-tab-user-edit"
                                                        data-toggle="tab" data-target="#nav-attachments-user-edit" type="button"
                                                        role="tab" aria-controls="nav-attachments-user-edit"
                                                        aria-selected="false">Attachments</button>
                                                </div>
                                            </nav>
                                        </div>
                                        ...
                                        <div class="block  block-transparent mb-0">
                                                    ...
                                                    @if ($c_check == 0)
                                                        <div class="col-sm-4  form-group">
                                                            ...
                                                            <select type="client_id" class="form-control selectpicker"
                                                                ...
                                                                data-live-search="true" id="user_id" title="All" value=""
                                                                name="user_id" placeholder="Client">
                                                                @foreach ($client as $c)
                                                                    <option value="{{ $c->id }}"
                                            ...
                                            <div class="block-content block-content-full   pt-4"
                                                ...
                                                @if (isset($_GET['advance_search']))
                                                    <a href="{{ url('users') }}"
                                                        class="btn     btn-new-secondary float-right"
                                                        style="background: black;
                color: goldenrod;">Clear Filters</a>
                                                @else
                                                    <a href="{{ url('users') }}"
                                                        class="btn     btn-new-secondary float-right" style="">Clear
                                                        Filters</a>
                                                @endif
                                            </div>
                                        </div>
                        ...
                        <form id='end-user' action="{{ url('end-user') }}" method="post">
                            @csrf
                                            ...
                                            <div class="block-content pt-0 row">
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <span class="font-titillium text-darkgrey" style="font-size: 14pt;">Are you sure
                                                        you wish to change the status of this User from <span
                        ...
                        <form action="{{ url('insert-comment-user') }}" id="insertComment" method="post">
                            @csrf
                        ...
                        <form action="{{ url('insert-attachment-user') }}" id="insertAttachment" method="post">
                            @csrf
                            <input type="hidden" name="id" value="{{ $GETID }}">
                        ...
                        <!--   <form class="mb-0 pb-0" action="{{ url('delete-attachment-user') }}" method="post">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    @csrf
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      <div class="modal-dialog modal-dialog-centered  -lg modal-bac " role="document">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <div class="modal-content">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          <div class="block  block-transparent mb-0">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            <div class="block-content new-block-content pt-0 pb-0 ">
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              <input type="hidden" id="del_client_id" name="user_id">
                ...
                <div class="modal fade" id="deleteCommentModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form id="deleteCommentForm" class="mb-0" method="POST" action="delete-comment-user">
                                @csrf
                                <div class="modal-header align-items-center border-0">
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form id="deleteAttachmentForm" class="mb-0" method="POST"
                                action="{{ url('delete-attachment-user') }}">
                                @csrf
                                <div class="modal-header align-items-center border-0">
                                    <h5 class="modal-title font-titillium fw-800 text-header-blue" style="font-size: 18pt;">Delete
                                    </h5>
                ...
                <div class="modal fade" id="deleteUserModal" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form id="deleteUserForm" class="mb-0" method="POST" action="{{ url('delete-contract') }}">
                                @csrf
                                <div class="modal-header align-items-center border-0">
                                    <h5 class="modal-title font-titillium fw-800 text-header-blue" style="font-size: 18pt;">Delete
                                    </h5>
                                ...
                                <div class="modal-footer border-0 pt-0" style="justify-content: space-evenly;">
                                    <button type="button" id="deleteUserBtn" class="btn del-btn btn-danger">Delete</button>
                                    <button type="button" class="btn cancel-btn" data-dismiss="modal">Cancel</button>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            <form id="changePasswordForm" class="mb-0">
                                ...
                                <div class="modal-body py-0">
                                    <input type="hidden" name="id" id="change_password_user_id">
                                    <div class="mb-3">
                                        <label class="font-titillium text-darkgrey fw-600 mb-1 d-block">New Password</label>
                                        <input type="password" class="form-control" name="password" id="new_user_password"
                                            autocomplete="new-password">
                                    </div>
                                    <div class="mb-3">
                                        <label class="font-titillium text-darkgrey fw-600 mb-1 d-block">Confirm Password</label>
                                        <input type="password" class="form-control" name="password_confirmation"
                                            id="confirm_user_password" autocomplete="new-password">
                                    </div>
                                    <div class="mb-2">
                                        <label class="d-flex align-items-center font-titillium text-darkgrey mb-0">
                                            <input type="checkbox" name="must_change" id="must_change_on_login" value="1"
                                                checked class="mr-2">
                                ...
                                <div class="modal-footer border-0 pt-0" style="justify-content: space-evenly;">
                                    <button type="button" id="changeUserPasswordBtn" class="btn ok-btn btn-primary">Update</button>
                                    <button type="button" class="btn cancel-btn" data-dismiss="modal">Cancel</button>
                                </div>
                            </form>
                        </div>
                ...
                <div class="modal fade" id="resendInviteProgressModal" tabindex="-1" role="dialog"
                    aria-labelledby="resendInviteProgressModalLabel" aria-hidden="true" data-bs-backdrop="static">
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body pt-0 pb-4 px-4">
                                <div class="d-flex align-items-center">
                                    ...
                                    <span class="font-titillium text-darkgrey" style="font-size: 14pt;"
                                        id="resendInviteProgressText">Please wait while re-sending invitation.</span>
                                </div>
                            </div>
                        </div>
                    </div>
...
<div class="modal fade" id="unsavedChangesModal" tabindex="-1" role="dialog" aria-labelledby="unsavedChangesModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
            ...
            <form id="leaveForm" class="mb-0" method="POST" action="delete-comment-contract">
                ...
                <script>
                    ...
                    $(document).on('click', '.read-nav-tabs .nav-link', function() {
                        ...
                        localStorage.setItem('user_active_tab', currentTab);
                        localStorage.setItem('user_active_tab_target', target);
                    })
                    ...
                    function loadAllAssetsModal(excludeIds, pn_no) {
                        ...
                        let clientId = $('input[name="user_id"]').val();
                ...
                $(function() {
                    ...
                    $(document).on('click', '.add-email-notify', function(event) {
                        ...
                        $('.added-notify-email tbody').append(`
                                            <tr class="email-notify-item banner-icon" data-user-id="${client_id}">
                                                ...
                                                <td class="py-2 border-0 text-right align-middle" width="50" style="border-radius: 0 13px 13px 0;">
                                                    <a href="javascript:;" class="align-items-center d-flex drag-handle justify-content-center mb-0 remove-notification" data-user-id="${client_id}" data-email="${email}">
                    ...
                    $(document).on('click', '.add-pinned-message', function(event) {
                        ...
                        $('.added-pinned-message tbody').append(`
                            <tr class="pinned-message-item" data-user-id="${client_id}">
                                <td class="py-2 border-0" style="border-radius: 13px 0 0 13px;">
                                ...
                                <td class="py-2 border-0 text-right align-middle" width="50" style="border-radius: 0 13px 13px 0;">
                                    ...
                                    data-message="${message}" data-user-id="${client_id}">
                    ...
                    $(document).on('click', '.btn-add-pin-messages', function() {
                        ...
                        let client_id = $(this).attr('data-user-id');
        ...
        `,
                    ...
                    $(document).on('click', '#downloadDistributerCSV', function() {
                        var table = $('.distributer-table');
                        let rows = [
                    ...
                    $(document).on('mouseenter', '.delete-comment-user', function() {
                        $(this).find('i').addClass('fa-solid').removeClass('fa-thin');
                    });

                    $(document).on('mouseleave', '.delete-comment-user', function() {
                        $(this).find('i').addClass('fa-thin').removeClass('fa-solid');
                    });
                    ...
                    $(document).on('click', '.btn-edit, .btn-edit-3dot', function(e) {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $('#nav-main-tab-user-edit').addClass('active');
                                $('#nav-main-user-edit').addClass('show active');
                            },
                            error: function() {
                    ...
                    $(document).on('click', '.btn-change-password, .btn-change-password-trigger', function(e) {
                        e.preventDefault();
                        e.stopPropagation();

                        var id = $(this).attr('data-user-id') || $(this).attr('data') || $(this).attr('data-id');
                        var email = $(this).attr('data-user-email') || '';

                        if (!id) {
                            id = $('.sub-nav-icons').attr('data');
                        }

                        $('#change_password_user_id').val(id || '');
                        $('#new_user_password').val('');
                        $('#confirm_user_password').val('');
                        $('#must_change_on_login').prop('checked', true);
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                setTimeout(function() {
                                    ...
                                    sessionStorage.setItem('successTitle', "Password Updated Successfully");
                                        sessionStorage.setItem('successMessage',
                                            "Password has been reset and notification email has been sent.");
                                    location.reload();
                                }, 2000);
                            },
                            error: function(xhr) {
                    ...
                    $(document).on('click', '.btn-resend-invite, .btn-resend-invite-3dot', function(e) {
                        e.preventDefault();
                        e.stopPropagation();

                        var id = $(this).attr('data-user-id') || $(this).attr('data') || $(this).attr('data-id');
                        var email = $(this).attr('data-user-email') || $('.btn-resend-invite').attr('data-user-email') || '';
                        ...
                        var progressText = 'Please wait while re-sending invitation.';
                        if (email) {
                            progressText = 'Please wait while re-sending invitation to ' + email;
                        }

                        $('#resendInviteProgressText').text(progressText);
                        $('#resendInviteProgressModal').modal('show');

                        $.ajax({
                            url: '{{ url('resend-user-invite') }}',
                            type: 'POST',
                            data: {
                                id: id,
                                _token: '{{ csrf_token() }}'
                            ...
                            success: function(response) {
                                setTimeout(function() {
                                    $('#resendInviteProgressModal').modal('hide');
                                    sessionStorage.setItem('successTitle', "Successfully sent email notification");
                                        sessionStorage.setItem('successMessage',
                            ...
                            error: function(xhr) {
                                $('#resendInviteProgressModal').modal('hide');
                                var message = 'Failed to resend invitation.';
                                if (xhr.responseJSON && xhr.responseJSON.message) {
                                    message = xhr.responseJSON.message;
                                }
                                showError(message);
                        ...
                        Dashmix.helpers('notify', {
                            ...
                            message: `
                                <div>
                                    ...
                                    <div>
                                        <a href="javascript:void(0);" class="text-secondary fw-600 undo-deleted-${type} float-right fs-18 my-1" data-${type}-id="${type_id}" data-user-id="${client_id}">Undo</a>
                                    </div>
                                </div>
                            `,
                            allow_dismiss: true,
                    ...
                    $(document).on('click', '.delete-comment-user', function() {
                        const commentId = $(this).data('id');
                        const clientId = $(this).data('user-id');

                        // Populate modal fields
                        $('#deleteCommentModal #comment_id').val(commentId);
                        $('#deleteCommentModal #user_id').val(clientId);
                    ...
                    $('#updateCommentBtn').on('click', function() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                localStorage.setItem('user_active_tab_target', 'nav-comments-user');
                        localStorage.setItem('user_active_tab', 'nav-comments-tab-user');
                                setTimeout(function() {
                                    location.reload();
                                }, 4000);
                            },
                    ...
                    $('#insertAttachment').on('submit', function() {
                        localStorage.setItem('user_active_tab_target', 'nav-attachments-client');
                        localStorage.setItem('user_active_tab', 'nav-attachments-tab-client');
                    });
                    $('#deleteCommentBtn').on('click', function() {
                        const formData = $('#deleteCommentForm').serialize();

                        $.ajax({
                            url: '{{ url('delete-comment-user') }}',
                            type: 'POST',
                            data: formData,
                            success: function(response) {
                                ...
                                localStorage.setItem('user_active_tab_target',
                                    'nav-comments-user');
                                localStorage.setItem('user_active_tab',
                                    'nav-comments-tab-user');
                                setTimeout(function() {
                                    location.reload();
                                }, 4000);
                            },
                    ...
                    $(document).on('click', '.undo-deleted-comment', function() {
                        ...
                        const contractId = $(this).data('user-id');

                        $.ajax({
                            url: '{{ url('undo-delete-comment-user') }}',
                            type: 'POST',
                            data: {
                ...
                `,
                    ...
                    $('#deleteAttachmentBtn').on('click', function() {
                        ...
                        $.ajax({
                            url: '{{ url('delete-attachment-user') }}',
                            type: 'POST',
                            data: formData,
                            success: function(response) {
                    ...
                    $(document).on('click', '.undo-deleted-attachment', function() {
                        ...
                        $.ajax({
                            url: '{{ url('undo-delete-attachment-user') }}',
                            type: 'POST',
                            data: {
                ...
                `,
                    ...
                    $(document).on('click', '#deleteUserBtn', function() {
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                showDeleteNotify('Deleted Successfully',
                                    'User has been deleted successfully.', response.id, response
                                    .id, 'user');
                                setTimeout(function() {
                                    location.reload();
                                }, 4000);
                    ...
                    $(document).on('click', '.undo-deleted-user', function() {
                        const clientId = $(this).data('user-id');

                        $.ajax({
                            url: '{{ url('delete-user-undo') }}',
                            type: 'POST',
                            data: {
                                id: clientId,
                                _token: '{{ csrf_token() }}' // ✅ important for Laravel
                    ...
                    function showData(id) {
                        ...
                        $.ajax({
                            ...
                            success: function(res) {
                                ...
                                $('.btn-change-password').attr('data-user-id', res.id);
                                $('.btn-change-password').attr('data-user-email', res.header_desc);
                                $('.btn-resend-invite').attr('data-user-id', res.id);
                                $('.btn-resend-invite').attr('data-user-email', res.header_desc);
                                var invitedFlag = parseInt(
                                    (typeof res.must_change !== 'undefined' ? res.must_change : res.mustChange),
                                    10
                                );
                                if (invitedFlag === 1) {
                                    $('.btn-resend-invite').removeClass('d-none');
                                } else {
                                    $('.btn-resend-invite').addClass('d-none');
                                }
                                ...
                                const targetSection = localStorage.getItem('user_active_tab_target');
                                if (savedTab && targetSection) {
                                    ...
                                    $('.sub-nav-tabs .nav-link').removeClass('active');
                                    $('.tab-pane').removeClass('show active');
                                    $('#nav-main-tab-user').addClass('active');
                                    $('#nav-main-user').addClass('show active');
                                }
        ...
        `);
                    ...
                    $(document).on('click', '.undo-delete-attachment', function() {
                        var client_id = $(this).attr('data-user-id');
                        var id = $(this).attr('data');
                        window.location.href = "{{ url('undo-delete-attachment-user') }}?id=" + id +
                            "&client_id=" + client_id;
                    });
                    ...
                    @if (Session::has('alert-delete-attachment'))
                        ...
                        Dashmix.helpers('notify', {
                            from: 'bottom',
                            align: 'left',
                            message: message + ' <a href="javascript:;" data="' + id + '" data-user-id="' +
                                client_id +
