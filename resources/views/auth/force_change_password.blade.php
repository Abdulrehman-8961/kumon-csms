 ...
 <head>
     ...
     <title>Change Password - YKK Control Point</title>
     ...
     <link rel="icon" type="image/png" sizes="192x192" href="{{ asset('public/logo/favicon.ico') }}">

     <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('public/logo/apple-touch-icon.png') }}">
     <link
 ...
 <body>
     <div class="bg-image"
         style="background-color: #f0f3f8!important; backgr ound-image: url('{{ asset('public') }}/dashboard_assets/media/photos/photo22@2x.jpg');">
                     ...
                     <div class="row no-gutters justify-content-center">
                         <div class="" style="width:500px;">
                             ...
                             <div class="login-content">
                                 <form class="js-validation-signin" action="{{ url('/change-password') }}"
                                     method="POST">
                                     @csrf
                                     <div class="pt-3">
                                         <div class="form-group">
                                             <input type="password"
                                                 class="form-control form-control-lg form-control-alt  @error('new_password') is-invalid @enderror"
                                                 id="new_password" name="new_password" placeholder="New Password">

                                         </div>
                                         <div class="form-group">
                                             <input type="password"
                                                 class="form-control form-control-lg form-control-alt  @error('confirm_password') is-invalid @enderror"
                                                 id="confirm_password" name="confirm_password"
                                                 placeholder="Confirm New Password">

                                         </div>
                                         <div class="tooltip-box mb-2">
                                     ...
                                     <div class="form-group">
                                         <button type="submit"
                                             class="btn btn-block btn-hero-lg signin-btn btn-hero-primary">
                                             Set Password
                                         </button>
                                     </div>
                                 </form>
