      ...
      <style>
          ...
          .payment-method-lock:hover .payment-lock-btn {
              opacity: 1;
              pointer-events: auto;
          }

          .payment-lock-btn:hover,
          ...
          .amount-edit-lock:hover .amount-lock-btn {
              opacity: 1;
              pointer-events: auto;
          }

          .amount-lock-btn:hover,
          .amount-lock-btn:focus {
              color: #1f6feb;
          }
      </style>
      @if ($client->is_active == 0)
          <div class="align-items-center container d-flex mb-0 px-2 py-1 mt-2 warning-info-edit">
              <i class="fa-solid fa-octagon-exclamation text-red fs-16 mr-2"></i>
              <p class="font-titillium fs-16 fw-700 mb-0 mr-2" style="color: #262626;">
                  WARNING:
              </p>
              <p class="font-titillium fs-16 fw-500 mb-0" style="color: #3f3f3f;">
                  Editing an inactive client
              </p>
          </div>
      @endif
      <input type="hidden" name="edit_form_id" id="edit_form_id" value="{{ $client->id }}">
      <div class="tab-content pr-3" id="nav-tabContent-edit" style="overflow-y: auto;">
          {{-- Main Tab --}}
          <div class="tab-pane fade show active" id="nav-main-client-edit" role="tabpanel"
              ...
              <div class="block new-block position-relative mt-3">
                  <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                      <div class="row">
                          <div class="col-sm-12">
                              <h5 class="titillium-web-black mb-3 text-darkblue">General Information</h5>
                          </div>
                          <div class="col-sm-2">
                          ...
                          {{-- line 4 start --}}
                          <div class="col-sm-6">
                              <div class="border p-2 mb-3 border-style edit-radio-border position-relative payment-method-lock bg-disabled"
                                  style="padding-bottom: 5px !important;">
                                  <div class="unlock-payment-toast" role="status" aria-live="polite">
                                      <div class="d-flex align-items-center justify-content-between">
                                          <div class="d-flex align-items-center">
                                              <i class="fa-light fa-circle-check mr-2"></i>
                                              <span class="font-titillium fs-14 text-darkgrey">Payment method
                                                  unlocked</span>
                                          </div>
                                      </div>
                                  </div>
                                  <a href="javascript:void();" class="mandatory-icon position-absolute"
                                      ...
                                      data-placement="top" title="" data-original-title="Mandatory"><i
                                          class="fa-light fa-circle-star text-grey fs-20"></i></a>
                                  <button type="button" class="btn payment-lock-btn" title="Change Payment Method"
                          ...
                          <input type="hidden" id="old_payment_method" name="old_payment_method"
                              value="{{ $client->payment_method }}">
                          <input type="hidden" id="new_payment_method" name="new_payment_method" value="">
                          <input type="hidden" id="payment_method_changed" name="payment_method_changed"
                              value="0">
                          <div class="col-sm-6">
              ...
              <div class="block new-block position-relative mt-3">
                  <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                      <div class="row">
                          <div class="col-sm-12">
                              <h5 class="titillium-web-black mb-3 text-darkblue">Additional Emails</h5>
                          </div>
                          <div class="col-sm-6">
                              <div class="border p-2 mb-3 border-style">
                                  <div class="d-flex align-items-center justify-content-between mb-2">
                                      <h6 class="font-titillium text-grey mb-0 fw-700 pl-1">Notifications</h6>
                                      <button type="button"
                                          class="btn banner-icon affiliate-info ml-auto p-0 cursor-help"
                                          data-toggle="tooltip" data-trigger="hover" data-placement="top"
                                          title="" data-original-title="">
                          ...
                          <div class="col-sm-12">
                              <div class="border py-2 pl-2 pr-1 mb-3 border-style positon-relative">
                                  <div class="d-flex align-items-center justify-content-between my-2">
                                      <h6 class="font-titillium text-grey mb-0 fw-700 pl-2">Email Addresses</h6>
                                  </div>
                                  <div class="table-responsive pr-2 small-box small-box-no-arrow">
                                      <table
                                          class="table table-sm table-striped align-middle mb-0 added-emails add-page">
                                          <tbody>
                                              <!-- New emails will be added here -->
                                          </tbody>
                                      </table>
                                  </div>
                                  <div class="font-titillium text-darkgrey fw-400 mb-0 text-center py-3 no-email">No
                                      details found</div>
                                  <div class="email-toast-added" role="status" aria-live="polite">
                                      <div class="d-flex align-items-center justify-content-between">
                                          <div class="d-flex align-items-center">
                                              <i class="fa-light fa-circle-check mr-2"></i>
                                          ...
                                          <button type="button" data-section="email-toast-added"
                                  ...
                                  <div class="email-toast-updated" role="status" aria-live="polite">
                                      <div class="d-flex align-items-center justify-content-between">
                                          <div class="d-flex align-items-center">
                                              <i class="fa-light fa-circle-check mr-2"></i>
                                          ...
                                          <button type="button" data-section="email-toast-updated"
                                              class="btn p-0 btn-close-toast text-darkgrey" aria-label="Close">
                                              <i class="fa-light fa-xmark"></i>
                                          </button>
                                      </div>
                                  ...
                                  <div class="email-toast-recovered" role="status" aria-live="polite">
                                      <div class="d-flex align-items-center justify-content-between">
                                          <div class="d-flex align-items-center">
                                              <i class="fa-light fa-circle-check mr-2"></i>
                                          ...
                                          <button type="button" data-section="email-toast-recovered"
                                              class="btn p-0 btn-close-toast text-darkgrey" aria-label="Close">
                                              <i class="fa-light fa-xmark"></i>
                                          </button>
                                      </div>
                                  ...
                                  <div class="email-toast-deleted" role="status" aria-live="polite">
                                      <div class="d-flex align-items-center justify-content-between">
                                          <div class="d-flex align-items-center">
                                              <i class="fa-light fa-circle-check mr-2"></i>
                                          ...
                                          <div class="d-flex align-items-center">
                                              <button type="button"
                                                  class="btn text-darkgrey btn-undo undo-delete-email font-titillium fs-14 mr-2"
                                                  data-action="undo">
                                                  Undo
                                              </button>
                                              <button type="button" data-section="email-toast-deleted"
                                                  class="btn p-0 btn-close-toast text-darkgrey" aria-label="Close">
                                                  <i class="fa-light fa-xmark"></i>
                                              </button>
                                          </div>
          ...
          <div class="tab-pane fade" id="nav-students-client-edit" role="tabpanel"
              ...
              <div class="block new-block position-relative mt-3">
                  <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                      <div class="row">
                          <div class="col-sm-12">
                              <h5 class="titillium-web-black mb-3 text-darkblue">Students</h5>
                          </div>
                          <div class="col-sm-12">
                              <div class="border p-2 mb-3 border-style">
          ...
          <div class="tab-pane fade show active" id="nav-payments-client-edit" role="tabpanel"
              ...
              <div class="block new-block position-relative mt-3" style="margin-bottom: 1rem;">
                  <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                      <div class="row">
                          <div class="col-sm-12">
                              <h5 class="titillium-web-black mb-3 text-darkblue">Payments</h5>
                          </div>
                          <div class="col-sm-12">
                              <div class="border p-2 mb-3 border-style">
          ...
          <div class="tab-pane fade show active" id="nav-vacations-client-edit" role="tabpanel"
              ...
              <div class="block new-block position-relative mt-3">
                  <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                      <div class="row">
                          <div class="col-sm-12">
                              <h5 class="titillium-web-black mb-3 text-darkblue">Vacations</h5>
                          </div>
                          <div class="col-sm-12">
                              <div class="border p-2 mb-3 border-style">
                                  <div class="table-responsive small-box small-box-395 small-box-no-arrow">
          ...
          <div class="tab-pane fade show active" id="nav-comments-client-edit" role="tabpanel"
              ...
              <div class="block new-block position-relative mt-3">
                  <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                      <div class="row">
                          <div class="col-sm-12">
                              <h5 class="titillium-web-black mb-3 text-darkblue">Comments</h5>
                          </div>
          ...
          <div class="tab-pane fade show active" id="nav-attachments-client-edit" role="tabpanel"
              ...
              <div class="block new-block position-relative mt-3">
                  <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                      <div class="row">
                          <div class="col-sm-12">
                              <h5 class="titillium-web-black mb-3 text-darkblue">Attachments</h5>
                          </div>
      ...
      <div class="modal fade" id="AddNewCurrencyModal" tabindex="-1" role="dialog"
          aria-labelledby="AddNewCurrencyModalLabel" aria-hidden="true" data-dropdown="currency-dropdown"
      ...
      <div class="modal fade" id="AddNewManageByModal" tabindex="-1" role="dialog"
          aria-labelledby="AddNewManageByModalLabel" aria-hidden="true" data-dropdown="managed-by-dropdown"
          data-bs-backdrop="static">
          <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                  <form id=" " class="mb-0" method="POST" action=" ">
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                  <form id="editDistributionForm" class="mb-0" method="POST"
                      ...
                      <input type="hidden" id="studentStatus">
                      <input type="hidden" id="amount_edit_old" value="">
                      <div class="modal-body py-0">
                          <div class="col-sm-12">
                              <div class="border p-2 mb-3 border-style edit-border">
                                  <h6 class="font-titillium text-grey mb-2 fw-700 pl-1">Student ID</h6>
                          ...
                          <div class="col-sm-5">
                              <div
                                  class="border p-2 mb-3 border-style edit-border amount-edit-lock bg-disabled position-relative">
                                  <div class="unlock-amount-toast" role="status" aria-live="polite">
                                      <div class="d-flex align-items-center justify-content-between">
                                          <div class="d-flex align-items-center">
                                              <i class="fa-light fa-circle-check mr-2"></i>
                                              <span class="font-titillium fs-14 text-darkgrey">Price change
                                                  unlocked</span>
                                          </div>
                                      </div>
                                  </div>
                                  <h6 class="font-titillium text-grey mb-2 fw-700 pl-1">Amount</h6>
                                  <button type="button" class="btn amount-lock-btn" title="Change Amount"
      ...
      <div class="modal fade" id="receiptPromptModal" tabindex="-1" role="dialog"
          aria-labelledby="receiptPromptModalLabel" aria-hidden="true" data-bs-backdrop="static">
          <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                  <div class="modal-header align-items-center border-0">
                  ...
                  <div class="modal-body py-0">
                      <div class="d-flex align-items-center">
                          ...
                          <span class="font-titillium text-darkgrey" style="font-size: 14pt;">Would you like to
                              print or
                  ...
                  <div class="modal-footer border-0 pt-0" style="justify-content: space-evenly;">
                      ...
                      <button type="button"
                          class="btn ntfy-btn btn-warning receipt-email text-black">Email</button>
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-footer border-0 pt-0" style="justify-content: space-evenly;">
                      <button type="button" class="btn ok-btn btn-primary"
                          id="printCenterReceiptBtn">Print</button>
                  ...
                  <div class="modal-body py-0">
                      <div class="col-sm-12">
                          <div class="custom-dropdown border p-2 mb-3 border-style edit-border student-dropdown"
                              style="padding-bottom: 0px !important;" data-selected-id="" data-selected-text="">
                              ...
                              <div class="d-flex align-items-center justify-content-between pb-1 pl-1 pt-0">
                                  <div class="custom-control custom-switch">
                                      <input type="checkbox" class="custom-control-input"
                                          id="reducedWorkloadSwitch" name="reduced_workload">
                                      <label class="custom-control-label" for="reducedWorkloadSwitch"
                                          ...
                                          <h6 class="font-titillium text-grey fw-300 mb-0 ml-2 switch-text-load">
                                              Student does not require reduced workload
                                          </h6>
                                      </label>
                                  </div>
                              </div>
                      ...
                      <div class="col-sm-12">
                          <div class="border p-2 mb-3 border-style d-none" id="reducedWorkloadWrapperEdit">
                              ...
                              <div class="d-flex align-items-center justify-content-between pb-1 pl-1 pt-0">
                                  <div class="custom-control custom-switch">
                                      <input type="checkbox" class="custom-control-input"
                                          id="reducedWorkloadSwitchEdit" name="reduced_workload_edit">
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body pt-0 pb-4 px-4">
                      <div class="d-flex align-items-center">
                          ...
                          <span class="font-titillium text-darkgrey" style="font-size: 14pt;">Saving form...</span>
                      </div>
                  </div>
              </div>
          </div>
      </div>
      <div class="modal fade" id="FormSavedModal" tabindex="-1" role="dialog"
          aria-labelledby="FormSavedModalLabel" aria-hidden="true" data-bs-backdrop="static">
          <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                  <div class="modal-header align-items-center border-0">
                      <h5 class="modal-title font-titillium fw-800 text-header-blue" style="font-size: 18pt;">
                  ...
                  <div class="modal-body py-0">
                      <div class="d-flex align-items-center mb-3">
                          <i class="fa-light fa-circle-check text-success fs-30 mr-2"></i>
                          <span class="font-titillium text-darkgrey" style="font-size: 14pt;">
                              Form saved and email sent to <span id="formSavedAdminEmail"></span>.
                          </span>
                      </div>
                  </div>
                  <div class="modal-footer border-0 pt-0" style="justify-content: space-evenly;">
                      <button type="button" class="btn ok-btn btn-primary" id="formSavedOkBtn">OK</button>
                  </div>
              </div>
          </div>
      </div>
      <div class="modal fade" id="paymentMethodChangeModal" tabindex="-1" role="dialog"
          aria-labelledby="paymentMethodChangeModalLabel" aria-hidden="true" data-bs-backdrop="static">
          <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                  <div class="modal-header align-items-center border-0">
                      <h5 class="modal-title font-titillium fw-800 text-header-blue" style="font-size: 18pt;">
                  ...
                  <div class="modal-body py-0">
                      <div class="d-flex align-items-center mb-3">
                          <i class="fa-light fa-triangle-exclamation text-warning fs-30 mr-2"></i>
                          <span class="font-titillium text-darkgrey" style="font-size: 14pt;">
                              Payment method will change from <span id="paymentMethodOld"></span> to
                              <span id="paymentMethodNew"></span>.
                          </span>
                      </div>
                  </div>
                  <div class="modal-footer border-0 pt-0" style="justify-content: space-evenly;">
                      <button type="button" class="btn ok-btn btn-primary"
                          id="confirmPaymentMethodChange">Yes</button>
                      <button type="button" class="btn cancel-btn" data-dismiss="modal">No</button>
                  </div>
              </div>
          </div>
      ...
      <script type="text/javascript">
          $(document).ready(function() {
              ...
              $(document).on('keydown', '#addEmailModal', function(e) {
                  if (e.key === 'Enter') {
                      ...
                      $('#add_email').trigger('click.editPage'); // act like OK button
                  }
              });
              $(document).on('keydown', '#addAffiliateClient', function(e) {
                  ...
                  if (e.key === 'Enter') {
                      ...
                      // Trigger OK button
                      $('#add_affiliate').trigger('click.editPage');
                  }
              });
              ...
              var students_array = [];
              var studentKey = 0;
              $(document).on('click.editPage', '#add_student', function() {
                  ...
                  // Validation
                  if (student_id === '' || student_name === '' || start_date === '' || subjects.length === 0 || amount === '') {
        ...
        <tr class="student-item" data="${i}" data-key="${students_array[i].key}">
            ...
            <td class="py-2 border-0 text-right drag-handle" width="50" style="opacity:0">
              ...
              $(document).on('click.editPage', '.edit-student', function() {
                  ...
                  $('#amount_edit_old').val(student.old_amount ?? student.amount);
              ...
              $(document).on('click.editPage', '.update-status-student', function() {
                  const index = $(this).attr('data');
              ...
              $(document).on('click.editPage', '#confirmStudentStatusDateBtn', function() {
              ...
              $(document).on('click.editPage', '#update_student', function() {
                  ...
                  const student_status = $('#studentStatus').val().trim();
                  const start_date = $('#student_start_date_edit').val().trim();
                  const amount = $('#amount_edit').val().trim();
                  const old_amount = $('#amount_edit_old').val().trim();
                  ...
                  const amountChanged = old_amount !== '' && amount !== '' && amount !== old_amount;
                  students_array[index] = {
                      ...
                      old_amount: students_array[index].old_amount ?? old_amount,
                      price_changed: (students_array[index].price_changed ?? false) || (
                          amountEditUnlocked && amountChanged)
                  };
              ...
              $(document).on('click.editPage', '.delete-student', function() {
                  const index = $(this).attr('data');
              ...
              $(document).on('click.editPage', '.undo-delete-student', function() {
                  const index = $(this).attr('data');
              ...
              $(document).on('click.editPage', '#add_payment', function() {
        ...
        <tr class="payment-item" data="${i}" data-key="${payments_array[i].key}">
            ...
            <td class="py-2 border-0 text-right drag-handle" width="50" style="opacity:0">
              ...
              $(document).on('click.editPage', '.edit-payment', function() {
              ...
              $(document).on('click.editPage', '#updte_payment', function() {
              ...
              function showReceiptPrompt(receiptData) {
                  $('#receiptPromptModal').data('receipt', receiptData || {}).modal('show');
              }

              $(document).on('click.editPage', '.receipt-print', function() {
                  const receiptData = $('#receiptPromptModal').data('receipt') || {};
                  $('#receiptPromptModal').modal('hide');
                  fetchCenterSettings(function() {
                      populateCenterReceiptPreview(receiptData);
                      $('#centerReceiptModal').modal('show');
                  });
              });

              $(document).on('click.editPage', '.receipt-email', function() {
                  $('#receiptPromptModal').modal('hide');
                  const receiptData = $('#receiptPromptModal').data('receipt') || {};
                  const email = $('#primary_email_address').val()?.trim() || '';
                  ...
                  $.ajax({
                      ...
                      data: {
                          ...
                          kumon_month: receiptData.kumon_month || '',
                          amount: receiptData.amount || '',
                          reference_no: receiptData.reference_no || ''
                      },
                      success: function(res) {
                          if (res && res.success) {
                              //   showSuccessNotify('Email Sent', 'Payment receipt has been emailed.');
                              Dashmix.helpers('notify', {
                                  type: 'success',
                                  message: `
                            <div>
                                <div class="font-titillium text-darkblue" style="font-weight: 800; font-size: 15pt;">Email Sent</div>
                                <div class="d-flex align-items-center">
          ...
          <div>Email sent to ${email}.</div>
                        ...
                        `,
                              ...
                              showError(res.message || 'Unable to send payment receipt.');
                          }
                      },
                      error: function() {
              ...
              function fetchCenterSettings(onDone) {
                  $.ajax({
                      ...
                      success: function(res) {
                          centerSettingsData.center_name = res?.center_name || '';
                          centerSettingsData.address = res?.address || '';
                          centerSettingsData.city = res?.city || '';
                          centerSettingsData.province = res?.province || '';
                          centerSettingsData.postal_code = res?.postal_code || '';
                          centerSettingsData.telephone = res?.telephone || '';
              ...
              function populateCenterReceiptPreview(receiptData) {
                  const firstName = $('#first_name').val()?.trim() || '';
                  const lastName = $('#last_name').val()?.trim() || '';
                  const clientName = `${firstName} ${lastName}`.trim();
                  const clientAddress = [
                      $('#client_address').val()?.trim() || '',
                      $('#city').val()?.trim() || '',
                      $('#province').val()?.trim() || '',
                  ...
                  const amountValue = receiptData.amount !== undefined && receiptData.amount !== null ?
                      `$${parseFloat(receiptData.amount).toFixed(2)}` :
                      '-';

                  $('#centerReceiptName').text(centerSettingsData.center_name || '');
                  $('#centerReceiptAddress').text(centerAddress);
                  ...
                  $('#centerReceiptClientAddress').text(clientAddress);
                  $('#centerReceiptPaymentMethod').text(receiptData.payment_type || '-');
                  $('#centerReceiptPaymentDate').text(receiptData.payment_date || '-');
                  $('#centerReceiptPaymentMonth').text(receiptData.kumon_month || '-');
                  $('#centerReceiptPaymentAmount').text(amountValue);
                  $('#centerReceiptPaymentReference').text(receiptData.reference_no || '-');
              }

              function printReceipt(selector) {
                  if ($('#centerReceiptModal').hasClass('show')) {
                      $('#centerReceiptModal').modal('hide');
              ...
              $('#printCenterReceiptBtn').on('click.editPage', function() {
                  $('#centerReceiptModal').one('hidden.bs.modal', function() {
                      printReceipt('#centerReceiptPreview');
                  }).modal('hide');
              });

              $(document).on('click.editPage', '.delete-payment', function() {
                  const index = $(this).attr('data');
              ...
              $(document).on('click.editPage', '.undo-delete-payment', function() {
        ...
        data-toggle="tooltip" data-placement="top" title="Inactive"></i>`;
           ...
           <i class="fa-duotone fa-solid fa-arrow-down-to-line fs-16 text-charcoal"></i>
         </span>` :
                          '';
           ...
           <i class="fa-duotone fa-solid fa-books fs-16 text-charcoal"></i>
         </span>` :
                          `<span data-toggle="tooltip" data-placement="top" title="No Work" class="vac-icon takework-icon">
           <i class="fa-duotone fa-solid fa-island-tropical fs-16 text-charcoal"></i>
         </span>`;
    ...
    `;
              ...
              $(document).on('click.editPage', '.clone-vacation', function() {
              ...
              $(document).on('click.editPage', '#add_vacation', function() {
              ...
              $(document).on('click.editPage', '.edit-vacation', function() {
              ...
              $(document).on('click.editPage', '#update_vacation', function() {
              ...
              $(document).on('click.editPage', '.delete-vacation', function() {
                  const index = $(this).attr('data');
              ...
              $(document).on('click.editPage', '.undo-delete-vacation', function() {
                  if (deleted_vacation) {
              ...
              $(document).on('click.editPage', '#btn-continue', function() {
              ...
              $('.header-item-code').text('Edit Client');
              $('.header-desc').text('{{ $desc }}');

              $(document).on('click.editPage', '.closeEditBtn', function() {
              ...
              $(document).on('click.editPage', '#viewReadBtn', function() {
              ...
              //   $(document).on('click.editPage', '.edit-distribution', function() {
              //       // Show modal
              ...
              //   $(document).on('click.editPage', '#add_purchasing', function() {
              ...
              $(document).on('click.editPage', '.client-custom-dropdown ul.dropdown-options li:not(.search-option)',
                  function(
                      e) {
              ...
              $(document).on('click.editPage', '.custom-dropdown ul.dropdown-options li:not(.search-option)',
                  function(
                      e) {
              ...
              $(document).on('click.editPage', '.assets-custom-dropdown .clear-icon', function(e) {
                  e.stopPropagation();
                  const assetsDropdown = $(this).closest('.assets-custom-dropdown');
                  const hiddenInput = assetsDropdown.next('input[type="hidden"]');
              ...
              $(document).on('click.editPage', '.assets-custom-dropdown .select-all', function(e) {
                  e.stopPropagation();
                  const assetsDropdown = $(this).closest('.assets-custom-dropdown');
              ...
              $(document).on('click.editPage', '.assets-custom-dropdown .deselect-all', function(e) {
                  e.stopPropagation();
                  const assetsDropdown = $(this).closest('.assets-custom-dropdown');
                  assetsDropdown.find('ul.dropdown-options li input[type="checkbox"]').prop('checked', false)
                      .trigger('change');
              ...
              $('.custom-dropdown').each(function() {
                  ...
                  box.on('click.editPage', '.dropdown-display', function(e) {
                      e.stopPropagation();
                  ...
                  options.on('click.editPage', function() {
                      const text = $(this).text();
                      const value = $(this).data('value');
                      selectedValue.text(text).css('color', '#3f3f3f');
                      console.log(value);
                  ...
                  // --- Clear selection ---
                  clearBtn.on('click.editPage', function(e) {
                      e.stopPropagation();
              ...
              // -------------------------
              //   $(document).on('click.editPage', '.multi-select-dropdown .dropdown-display', function(e) {
              //       e.stopPropagation();
              //       console.log('hhhh');
              ...
              $(document).on('click.editPage', '.multi-select-dropdown input[type="checkbox"]', function(e) {
                  e.stopPropagation();
                  const dropdown = $(this).closest('.multi-select-dropdown');
              ...
              $(document).on('click.editPage', '.multi-select-dropdown .select-all', function(e) {
                  e.stopPropagation();
                  const dropdown = $(this).closest('.multi-select-dropdown');
              ...
              $(document).on('click.editPage', '.multi-select-dropdown .deselect-all', function(e) {
                  e.stopPropagation();
                  const dropdown = $(this).closest('.multi-select-dropdown');
              ...
              $(document).on('click.editPage', '.multi-select-dropdown .clear-icon', function(e) {
                  e.stopPropagation();
                  const dropdown = $(this).closest('.multi-select-dropdown');
                  dropdown.find("input[type='checkbox']").prop('checked', false);
                  updateSelectedValues(dropdown);
              ...
              // -------------------------
              $(document).on('click.editPage', '.addable-dropdown .dropdown-display', function(e) {
                  e.stopPropagation();
                  const dropdown = $(this).closest('.custom-dropdown');
              ...
              $(document).on('click.editPage', '.addable-dropdown .dropdown-options li', function(e) {
                  const $item = $(this);
              ...
              $(document).on('click.editPage', '.addable-dropdown .add-new-btn', function(e) {
                  e.preventDefault();
                  e.stopPropagation();
              ...
              $(document).on('click.editPage', '.addable-save-btn', function() {
                  const btn = $(this);
        ...
        `;
              ...
              $('#add_email').on('click.editPage', function() {
              ...
              $(document).on('click.editPage', '.edit-email', function() {
              ...
              // Delete Email Row
              $(document).on('click.editPage', '.remove-email', function() {
              ...
              $(document).on('click.editPage', '.undo-delete-email', function(e) {
                  e.preventDefault();
              ...
              $('#add_affiliate').on('click.editPage', function() {
              ...
              $(document).on('click.editPage', '.remove-affiliate', function() {
                  var $tr = $(this).closest('tr');
                  var rowHtml = $tr.prop('outerHTML');
                  var index = $tr.index();
                  $('.dropdown-menu').removeClass('show');
              ...
              $(document).on('click.editPage', '.undo-delete-affiliate', function(e) {
                  e.preventDefault();
                  window._deletedAffiliates = window._deletedAffiliates || [];
              ...
              function initCustomCalendar(containerId, inputId, clearBtnId, defaultDate) {
                  ...
                  if (dateContainer._customCalendarApi && typeof dateContainer._customCalendarApi.destroy ===
                      'function') {
                  ...
                  function createMonthYearPicker() {
                      ...
                      function updateMonthButtons() {
                          ...
                          buttons.forEach((btn, index) => {
                              ...
                              if (selectedMonth !== null && selectedYear !== null && selectedMonth ===
                                  index && selectedYear === y) {
              ...
              // $(document).on('click.editPage', '.bootstrap-select .dropdown-item', function(event) {
              ...
              // $(document).on('click.editPage', '#NewCurrencySave', function() {
              ...
              $('#btnAddContractDetail').on('click.editPage', function() {
              ...
              // 🔹 Save (Add or Edit)
              //   $('#saveContractDetail').on('click.editPage', function() {
        ...
        //             </tr>`;
              ...
              // 🔹 Edit Row
              $(document).on('click.editPage', '.edit-contract-detail', function(e) {
                  e.preventDefault();
              ...
              // 🔹 Delete Row
              //   $(document).on('click.editPage', '.delete-contract-detail', function(e) {
              //       e.preventDefault();
              ...
              $(document).on('click.editPage', '.undo-delete-contract', function() {
            ...
            <a href="javascript:;" class="showAssetsModal_2 mt-0" data-assets="${dataAssets}" data-toggle="tooltip" data-trigger="hover"
              ...
              $(document).on('click.editPage', '.showAssetsModal_2', function(e) {
                  e.preventDefault();
          ...
          <tbody>`;
            ...
            <td class="py-2 text-center" style="vertical-align: middle;">
                <a href="javascript:void();" class="delete-asset-btn" 
                  ...
                  $('#assignedAssetsTable').on('click.editPage', '.delete-asset-btn', function(e) {
                      e.preventDefault();
                      e.stopPropagation();
              ...
              function setupUndoFunctionality() {
                  ...
                  $('.undo-delete-asset-array').off('click.editPage');

                  // Add new undo handler
                  $('.undo-delete-asset-array').on('click.editPage', function() {
                      undoLastRemoval();
                  });

                  // Close toast handler
                  $('.btn-close-toast[data-section="asset-array-toast-deleted"]').off('click.editPage').on(
                      'click.editPage',
                      function() {
                          clearUndoData();
              ...
              $(document).on('click.editPage', '#selectAssets', function() {
                  var pn_no = $(this).attr('data-pn_no');
                  if (pn_no) {
              ...
              $(document).on('click.editPage', '.pn-no-dropdown .dropdown-options li', function(e) {
              ...
              $(document).on('click.editPage', '#add_distribution', function() {
                  // Get values from modal inputs
              ...
              $(document).on('click.editPage', '#update_distribution', function() {
                  // Get values from modal inputs
              ...
              $(document).on('click.editPage', '.delete-distribution', function() {
              ...
              $(document).on('click.editPage', '.undo-delete-distribution', function() {
                  var id = $(this).attr('data');
              ...
              $(document).on('click.editPage', '#btnAddPurchasing', function() {
                  // Show modal
                  $('#editPurchasingModal').find('button.new-ok-btn').attr('id', 'add_purchasing');
                  $('#editPurchasingModal').modal('show');
              });
              //   $(document).on('click.editPage', '.edit-purchasing', function() {
              //       // Show modal
              //       $('#editPurchasingModal').modal('show');
              //   });
              ...
              $(document).on('click.editPage', '#update_purchasing', function() {
                  // Get values from modal inputs
              ...
              $(document).on('click.editPage', '.delete-purchasing', function() {
                  var id = $(this).attr('data');
              ...
              $(document).on('click.editPage', '.undo-delete-purchasing', function() {
                  var id = $(this).attr('data');
                  var key = $(this).attr('data1');
              ...
              const oldPaymentMethod = $('#old_payment_method').val() || '';

              let isToastShown = false;

              function setPaymentMethodLocked(isLocked) {
                  paymentMethodInputs.prop('disabled', isLocked);

                  $('.payment-lock-btn')
                      .toggleClass('is-unlocked', !isLocked)
                      .attr('title', isLocked ? 'Change Payment Method' : 'Payment Method Unlocked');

                  $('.payment-lock-btn i')
                      .removeClass('fa-lock fa-lock-open')
                      .addClass(isLocked ? 'fa-lock' : 'fa-lock-open');

                  $('.payment-method-lock').toggleClass('bg-disabled', isLocked);

                  // show toast only once per page load (first time it becomes unlocked)
                  if (!isLocked && !isToastShown) {
                      showToast('unlock-payment-toast');
                      isToastShown = true;
                  }
              }
              ...
              if (paymentMethodInputs.length) {
                  ...
                  $('#new_payment_method').val(oldPaymentMethod);
                  $('#payment_method_changed').val('0');
              }

              $(document).off('click.editPage', '.payment-lock-btn').on('click.editPage', '.payment-lock-btn',
                  function(e) {
                      e.preventDefault();
                      setPaymentMethodLocked(false);
                  });

              $(document).off('change.editPage', 'input[name="payment_method"]').on('change.editPage',
                  'input[name="payment_method"]',
                  function() {
                      const newPaymentMethod = $('input[name="payment_method"]:checked').val() || '';
                      const changed = newPaymentMethod && newPaymentMethod !== oldPaymentMethod;
                      $('#new_payment_method').val(newPaymentMethod);
                      $('#payment_method_changed').val(changed ? '1' : '0');
                  });

              const amountEditInput = $('#amount_edit');
              let amountEditUnlocked = false;

              let isAmountToastShown = false;

              function setAmountEditLocked(isLocked) {
                  amountEditInput.prop('disabled', isLocked);

                  $('.amount-lock-btn')
                      .toggleClass('is-unlocked', !isLocked)
                      .attr('title', isLocked ? 'Change Amount' : 'Amount Unlocked');

                  $('.amount-lock-btn i')
                      .removeClass('fa-lock fa-lock-open')
                      .addClass(isLocked ? 'fa-lock' : 'fa-lock-open');

                  $('.amount-edit-lock').toggleClass('bg-disabled', isLocked);

                  if (!isLocked && !isAmountToastShown) {
                      showToast('unlock-amount-toast'); // 👈 make sure this toast exists
                      isAmountToastShown = true;
                  }
              }


              $(document).off('shown.bs.modal.editPage', '#editStudentModal')
                  .on('shown.bs.modal.editPage', '#editStudentModal', function() {
                      setAmountEditLocked(true);
                      amountEditUnlocked = false;
                  });

              $(document).off('click.editPage', '.amount-lock-btn').on('click.editPage', '.amount-lock-btn',
                  function(e) {
                      e.preventDefault();
                      setAmountEditLocked(false);
                      amountEditUnlocked = true;
                  });
              $(document).off('click.editPage', '.updateBtn').on('click.editPage', '.updateBtn', function(e) {
                  e.preventDefault();
                  ...
                  let old_payment_method = $('#old_payment_method').val();
                  let new_payment_method = $('#new_payment_method').val();
                  let payment_method_changed = $('#payment_method_changed').val();
                  ...
                  if (!validfirst_name || !validlast_name || !validclient_address || !validpostal_code ||
                              ...
                              success: function(response) {
                                  ...
                                  setTimeout(function() {
                                      ...
                                      if (response && response
                                          .price_change_emails_sent) {
                                          sessionStorage.setItem('successTitle',
                                              'Client Edited Successfully');
                                          sessionStorage.setItem('successMessage',
                                              `form saved and email sent to ${response.admin_email || 'the administrator'}`
                                              );

                                          //   $('#formSavedAdminEmail').text(response.admin_email || 'the administrator');
                                          //   $('#FormSavedModal').modal('show');
                                          //   $('#formSavedOkBtn').off('click').one('click', function() {
                                          //       $('#FormSavedModal').modal('hide');
                                          //     });
                                          location.reload();
                                          return;
                                      }
                      ...
                      if (payment_method_changed === '1') {
                          $('#paymentMethodOld').text(old_payment_method || 'N/A');
                          $('#paymentMethodNew').text(new_payment_method || 'N/A');
                          $('#paymentMethodChangeModal').modal('show');
                          $('#confirmPaymentMethodChange')
                              .off('click')
                              .one('click', function() {
                                  $('#paymentMethodChangeModal').modal('hide');
                                  submitUpdate();
                              });
                          return false;
                      }
              ...
              $(document).on('click.editPage', '.btnEditCommentAdd', function() {
              ...
              $(document).on('click.editPage', '.btnDeleteCommentAdd', function() {
              ...
              $(document).on('click.editPage', '.btnCommentUndo', function() {
              ...
              $(document).on('click.editPage', '.btnDeleteAttachment', function() {
              ...
              $(document).on('click.editPage', '.btnAttachmentUndo', function() {
              ...
              $reducedWorkloadSwitch.on('change', function() {
                  if ($(this).is(':checked')) {
                      $('.switch-text-load').text('Student requires reduced workload');
                      $btn.prop('disabled', false).css({
                          opacity: 1,
                          cursor: 'pointer'
                      });
                  } else {
                      $('.switch-text-load').text('Student does not require reduced workload');
                      $btn.prop('disabled', true).css({
                          opacity: 0.5,
                          cursor: 'not-allowed'
                      });
