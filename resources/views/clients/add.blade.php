      ...
      ?>
      <style>
          #nav-vacations-tab-client-edit,
          #nav-payments-tab-client-edit {
                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-6">
                              <div class="border p-2 mb-3 border-style edit-border position-relative">
                                  ...
                                  <div class="d-flex pb-1 pl-1 pt-0">
                                      ...
                                      <input type="text"
                                          class="form-control font-titillium text-grey fw-300 mb-0 ml-2 border-0 p-0 fs-18 rounded-0 edit-field"
                                          placeholder="Enter last name" name="last_name" id="last_name" value="">
                                  </div>
                              </div>
                          </div>
                          {{-- line 2 start --}}
                          ...
                          <div class="col-sm-3">
                              <div class="custom-dropdown province-custom-dropdown border p-2 mb-3 border-style edit-border"
                                  data-selected-id="Quebec" data-selected-text="Quebec">
                                  <a href="javascript:void();" class="mandatory-icon position-absolute"
                                      style="right: 9px;" data-toggle="tooltip" data-trigger="hover"
                                      data-placement="top" title="" data-original-title="Mandatory"><i
                                          class="fa-light fa-circle-star text-grey fs-20"></i></a>
                                  ...
                                  <ul class="dropdown-options">
                                      ...
                                      <li data-value="Quebec" class="selected">Quebec</li>
                                      <li data-value="Saskatchewan">Saskatchewan</li>
                                  </ul>

                              </div>
                              <input type="hidden" name="province" id="edit_province" value="Quebec">
                          </div>
                          {{-- line 3 start --}}
                          <div class="col-sm-3">
                              <div class="border p-2 mb-3 border-style edit-border required position-relative">
                                  <a href="javascript:void();" class="mandatory-icon position-absolute"
                                      style="right: 9px;" data-toggle="tooltip" data-trigger="hover"
                                      data-placement="top" title="" data-original-title="Mandatory"><i
                                          class="fa-light fa-circle-star text-grey fs-20"></i></a>
                                      ...
                                      <div class="d-flex">
                                          <div class="radio_button ">
                                              <input type="radio" id="payment_method_credit_card"
                                                  name="payment_method" value="Credit Card" checked />
                                              <label
              ...
              <div class="block new-block position-relative mt-3">
                  <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                      <div class="row">
                          ...
                          <div class="col-sm-12 emails-container" style="display: none;">
                          ...
                          <div class="col-sm-12 text-right">
                              <button type="button"
                                  class="btn font-titillium fw-500 py-1 new-ok-btn btn-continue-tab"
                                  data-next="#nav-students-client-edit">Continue</button>
                          </div>
                      </div>
                  </div>
              </div>
              {{-- <div class="d-flex justify-content-end mt-2">
                  <button type="button" class="btn font-titillium fw-500 py-1 new-ok-btn btn-continue-tab"
                      data-next="#nav-students-client-edit" style="width: 120px;">Continue</button>
              </div> --}}
          </div>
          {{-- Students Tab --}}
          <div class="tab-pane fade" id="nav-students-client-edit" role="tabpanel"
              ...
              <div class="block new-block position-relative mt-3">
                  <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                      <div class="row">
                          <div class="col-sm-12">
                              <h5 class="titillium-web-black mb-3 text-darkgreen">Students</h5>
                          </div>
                          <div class="col-sm-12">
                              <div class="border p-2 mb-3 border-style">
                                  <div class="table-responsive small-box small-box-no-arrow">
                                      <table class="table table-sm table-striped align-middle mb-0 studentTable">
                                          <thead>
                                              ...
                                              <th class="py-2 border-0 pl-2" width="14%">
                                                  <h6
                                              ...
                                              <th class="py-2 border-0" width="15%">
              ...
              {{-- <div class="d-flex justify-content-end mt-2">
              <button type="button" class="btn font-titillium fw-500 py-1 new-ok-btn btn-continue-tab"
                  data-next="#nav-comments-client-edit" style="width: 120px;">Continue</button>
          </div> --}}
          </div>
          {{--
      <!-- Payment Tab -->
      <div class="tab-pane fade show active" id="nav-payments-client-edit" role="tabpanel"
          ...
          <div class="block new-block position-relative mt-3" style="margin-bottom: 1rem;">
              <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                  <div class="row">
                      <div class="col-sm-12">
                          <h5 class="titillium-web-black mb-3 text-darkgreen">Payments</h5>
                      </div>
                      <div class="col-sm-12">
                          <div class="border p-2 mb-3 border-style">
          ...
          <div class="d-flex justify-content-end mt-2">
              <button type="button" class="btn font-titillium fw-500 py-1 new-ok-btn btn-continue-tab"
                  data-next="#nav-vacations-client-edit" style="width: 120px;">Continue</button>
          </div>
      </div>
      ...
      <div class="tab-pane fade show active" id="nav-vacations-client-edit" role="tabpanel"
          ...
          <div class="block new-block position-relative mt-3">
              <div class="block-content py-0" style="padding-left: 30px;padding-right: 30px;">
                  <div class="row">
                      <div class="col-sm-12">
                          <h5 class="titillium-web-black mb-3 text-darkgreen">Vacations</h5>
                      </div>
                      <div class="col-sm-12">
                          <div class="border p-2 mb-3 border-style">
                              <div class="table-responsive small-box small-box-200 small-box-no-arrow">
                                  <table class="table table-sm table-striped align-middle mb-0 vacationTable">
                                      <thead>
                                          <th class="py-2 border-0 pl-2" width="3%"></th>
                                          <th class="py-2 border-0 pl-2" width="50%">
                                              <h6
                                                  class="font-titillium text-table-head mb-0 fw-700 border-right border-secondary">
                                                  Date</h6>
                                          </th>
                                          <th class="py-2 border-0 pl-2" width="45%">
                                              <h6 class="font-titillium text-table-head mb-0 fw-700">Number of Days
                                              </h6>
                                          </th>
                                          <th class="py-2 border-0 pl-3" width="2%"></th>
                                      </thead>
                                      <tbody></tbody>
                                  </table>
                                  <div
      ...
      --}}
          ...
          <div class="tab-pane fade show active" id="nav-comments-client-edit" role="tabpanel"
              ...
              {{-- <div class="d-flex justify-content-end mt-2">
                  <button type="button" class="btn font-titillium fw-500 py-1 new-ok-btn btn-continue-tab"
                      data-next="#nav-attachments-client-edit" style="width: 120px;">Continue</button>
              </div> --}}
          </div>
                          ...
                          <div class="col-sm-5">
                              <div class="border p-2 mb-3 border-style edit-border">
                                  ...
                                  <div class="d-flex pb-1 pl-1 pt-0">
                                      ...
                                      <input type="text"
                                          class="form-control font-titillium text-grey fw-300 mb-0 ml-2 border-0 p-0 fs-18 rounded-0 edit-field"
                                          id="amount_edit" value="135.00" inputmode="decimal" autocomplete="off">
                                  </div>
                              </div>
                          </div>
                      </div>
          ...
          <div class="modal-dialog modal-dialog-centered" role="document">
              <div class="modal-content">
                  ...
                  <div class="modal-footer border-0 pt-0" style="justify-content: space-evenly;">
                      <button type="button" class="btn ok-btn btn-primary receipt-print">Print</button>
                      <button type="button" class="btn ok-btn btn-warning receipt-email">Email</button>
              ...
              <div class="modal-content">
                  ...
                  <div class="modal-body pt-0 pb-4 px-4">
                      <div class="d-flex align-items-center">
                          ...
                          <span class="font-titillium text-darkgrey saving-text" style="font-size: 14pt;">Please
                              wait while
                              saving Client ...</span>
                      </div>
                  </div>
      ...
      <script type="text/javascript">
          $(document).ready(function() {
              ...
              var students_array = [];
              var studentKey = 0;
              $(document).on('click.addPage', '#add_student', function() {
        ...
        <tr class="payment-item" data="${i}" data-key="${payments_array[i].key}">
            ...
            <td class="py-2 border-0 text-right drag-handle" width="50" style="opacity:0">
              ...
              $(document).on('click.addPage', '.receipt-print', function() {
                  $('#receiptPromptModal').one('hidden.bs.modal', function() {
                      window.print();
                  }).modal('hide');
              });

              $(document).on('click.addPage', '.receipt-email', function() {
                  ...
                  $.ajax({
                      ...
                      success: function(res) {
                          if (res && res.success) {
                              showSuccessNotify('Email Sent',
                              'Payment receipt has been emailed.');
                          } else {
                      ...
                      html += `
                        <tr class="vacation-item" data="${i}">
                            ...
                            <td class="py-2 border-0 text-center" width="3%">
                                ${isUpcoming(v.date_range) ? '<i class="fa-light fa-triangle-exclamation text-warning fs-16" data-toggle="tooltip" data-placement="top" title="Upcoming"></i>' : ''}
                            </td>
                            ...
                            <td class="py-2 border-0 text-center" width="3%">${getBooleanText(v.take_work_home)}</td>
                            <td class="py-2 border-0 text-right" width="3%">${getBooleanText(v.reduced_workload)}</td>
                            <td class="py-2 border-0 text-center" width="3%">${getBooleanText(v.planned)}</td>
              ...
              $('.header-item-code').text('New Client');
              $('.header-desc').text('New Kumon Math & Reading Client');
                  ...
                  if (!validfirst_name || !validlast_name || !validclient_address || !validpostal_code ||
                      ...
                      $.ajax({
                          ...
                          beforeSend: function() {
                              ...
                              // Show modal
                              if (portal_access) {
                                  $('#SaveModal .saving-text').text(
                                      `saving and sending invite to ${primary_email_address} ...`
                                  );
                              }
...
localStorage.removeItem('client_active_tab_target');
                              ...
                              setTimeout(function() {
                                  ...
                                  if (btnType == "continue") {
                                      ...
                                      // ✅ Append invite info ONLY if invite was actually sent
                                      if (response.invite_sent) {
                                          message_ +=
    ...
    <div>
      ...
      <div class="d-flex align-items-center">
          ...
          <div>Continue adding new Client.</div>
      </div>
    </div>
    `,
                                          allow_dismiss: true,
                                      ...
                                      let title = 'Client Added Successfully';
                                      let message = 'Client has been added successfully.';

                                      // ✅ Append invite info ONLY if invite was actually sent
                                      if (response.invite_sent) {
                                          message += ` Invite sent to ${response.email}.`;
                                      }
              ...
              $(document).on('click.addPage', '.btn-continue-tab', function() {
                  const target = $(this).data('next');
                  if (!target) {
                      return;
                  }

                  const $tab = $('.sub-nav-tabs .nav-link[data-target="' + target + '"]');
                  if ($tab.length) {
                      $tab.trigger('click');
                      return;
                  }
