  ...
  public function view(): View
  {
    ...
    if (sizeof($_GET) > 0) {
      ...
      if (Auth::user()->role == 'admin') {
        ...
        $qry = DB::table('contracts as a')->select('a.*', 'c.client_display_name', 's.site_name', 'd.distributor_name', 'v.vendor_name', 'v.vendor_image')->join('clients as c', 'c.id', '=', 'a.client_id')->join('sites as s', 's.id', '=', 'a.site_id')->leftjoin('distributors as d', 'd.id', '=', 'a.distributor_id')->leftjoin('vendors as v', 'v.id', '=', 'a.vendor_id')->whereRaw("c.is_deleted=0 $cond")->where(function ($query) use ($sear) {
      ...
      if (Auth::user()->role == 'admin') {
        $qry = DB::table('contracts as a')->select('a.*', 'c.client_display_name', 's.site_name', 'd.distributor_name', 'v.vendor_name', 'v.vendor_image')->join('clients as c', 'c.id', '=', 'a.client_id')->join('sites as s', 's.id', '=', 'a.site_id')->leftjoin('distributors as d', 'd.id', '=', 'a.distributor_id')->leftjoin('vendors as v', 'v.id', '=', 'a.vendor_id')->where('a.is_deleted', 0)->orderBy('a.id', 'desc')->get();
      } else {
        $qry = DB::table('contracts as a')->select('a.*', 'c.client_display_name', 's.site_name', 'd.distributor_name', 'v.vendor_name', 'v.vendor_image')->join('clients as c', 'c.id', '=', 'a.client_id')->join('sites as s', 's.id', '=', 'a.site_id')->leftjoin('distributors as d', 'd.id', '=', 'a.distributor_id')->leftjoin('vendors as v', 'v.id', '=', 'a.vendor_id')->where('a.is_deleted', 0)->whereIn('a.client_id', $userAccess)->orderBy('a.id', 'desc')->get();
      }
    }
