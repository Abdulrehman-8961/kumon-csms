...
class ExportAssetsDetaiLine implements FromView
{
  protected $request;
  ...
  public function view(): View
  {
    ...
    // dd($this->request->detail_line);

    return view('exports.ExportAssetsDetailLine', [
      'qry' => $qry,
      'asset_type' => $this->request->asset_type,
      'type' => $this->request->detail_line
    ]);
  }
}
