...
use DB;
use Auth;
class ExportExcelPhysical implements FromView
{
    protected $request;
...
$query->Orwhere('a.type','like','%'.@$_GET['search'].'%');
 ...
 $query->OrwhereRaw("exists (select 1
     ...
     })->select('a.*','s.site_name','p.hostname as parent_asset_name','d.domain_name','c.client_display_name','o.operating_system_name','m.vendor_name','at.asset_icon','at.asset_type_description','n.vlan_id  as vlanId','c.logo')->join('clients as c','c.id','=','a.client_id')->join('sites as s','s.id','=','a.site_id')->leftjoin('operating_systems as o','o.id','=','a.os')->leftjoin('asset_type as at','at.asset_type_id','=','a.asset_type_id')->leftjoin('domains as d','d.id','=','a.domain')->leftjoin('vendors as m','m.id','=','a.manufacturer')->leftjoin('network as n','a.vlan_id','=','n.id')->leftjoin('assets as p','p.id','=','a.parent_asset') ->whereRaw("a.is_deleted=0 $cond")->where('a.is_deleted',0)->where('a.asset_type','physical') ->orderBy($field,$orderby)->get(); 
...
$query->Orwhere('a.type','like','%'.@$_GET['search'].'%');
 ...
 $query->OrwhereRaw("exists (select 1
     ...
     })->select('a.*','s.site_name','p.hostname as parent_asset_name','d.domain_name','c.client_display_name','o.operating_system_name','m.vendor_name','at.asset_icon','at.asset_type_description','n.vlan_id  as vlanId','c.logo')->join('clients as c','c.id','=','a.client_id')->join('sites as s','s.id','=','a.site_id')->leftjoin('operating_systems as o','o.id','=','a.os')->leftjoin('asset_type as at','at.asset_type_id','=','a.asset_type_id')->leftjoin('domains as d','d.id','=','a.domain')->leftjoin('vendors as m','m.id','=','a.manufacturer')->leftjoin('network as n','a.vlan_id','=','n.id')->leftjoin('assets as p','p.id','=','a.parent_asset') ->whereRaw("a.is_deleted=0 $cond")->where('a.is_deleted',0)->where('a.asset_type','physical')->whereIn('a.client_id',$userAccess)->orderBy($field,$orderby)->get(); 
...
$qry=DB::table('assets as a')->select('a.*','s.site_name','p.hostname as parent_asset_name','d.domain_name','c.client_display_name','o.operating_system_name','m.vendor_name','at.asset_icon','at.asset_type_description','n.vlan_id  as vlanId','c.logo')->join('clients as c','c.id','=','a.client_id')->join('sites as s','s.id','=','a.site_id')->leftjoin('operating_systems as o','o.id','=','a.os')->leftjoin('asset_type as at','at.asset_type_id','=','a.asset_type_id')->leftjoin('domains as d','d.id','=','a.domain')->leftjoin('vendors as m','m.id','=','a.manufacturer')->leftjoin('network as n','a.vlan_id','=','n.id')->leftjoin('assets as p','p.id','=','a.parent_asset') ->where('a.is_deleted',0)->where('a.asset_type','physical')->orderBy('a.id','asc')->get(); 
 
 }
else{ 

$qry=DB::table('assets as a')->select('a.*','s.site_name','p.hostname as parent_asset_name','d.domain_name','c.client_display_name','o.operating_system_name','m.vendor_name','at.asset_icon','at.asset_type_description','n.vlan_id  as vlanId','c.logo')->join('clients as c','c.id','=','a.client_id')->join('sites as s','s.id','=','a.site_id')->leftjoin('operating_systems as o','o.id','=','a.os')->leftjoin('asset_type as at','at.asset_type_id','=','a.asset_type_id')->leftjoin('domains as d','d.id','=','a.domain')->leftjoin('vendors as m','m.id','=','a.manufacturer')->leftjoin('network as n','a.vlan_id','=','n.id')->leftjoin('assets as p','p.id','=','a.parent_asset') ->where('a.is_deleted',0)->where('a.asset_type','physical')->whereIn('a.client_id',$userAccess)->orderBy('a.id','asc')->get(); 
